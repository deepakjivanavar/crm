        ...
        <div class="record-header clearfix">
            ...
            <div class="recordBasicInfo">
                ...
                <div class="info-row row">
                    ...
                    {if $FIELD_MODEL->isEditable() eq 'true' && ($FIELD_MODEL->getFieldDataType()!=nectarcrm_Field_Model::REFERENCE_TYPE) && $FIELD_MODEL->get('uitype') neq 69}
                        <span class="hide edit col-lg-6">
                           <input type="hidden" class="fieldBasicData" data-name='{$FIELD_MODEL->get('name')}' data-type="{$fieldDataType}" data-displayvalue='{nectarcrm_Util_Helper::toSafeHTML($FIELD_MODEL->getDisplayValue($FIELD_MODEL->get('fieldvalue')))}' data-value="{$FIELD_VALUE}" />
                        </span>
                    {/if}
                </div>
