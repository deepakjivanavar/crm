		...
		<div class="clearfix record-header ">
			...
			<div class="recordBasicInfo">
				...
				<div class="info-row">
					...
					<a class="showMap" href="javascript:void(0);" onclick='nectarcrm_Index_Js.showMap(this);' data-module='{$RECORD->getModule()->getName()}' data-record='{$RECORD->getId()}'>{vtranslate('LBL_SHOW_MAP', $MODULE_NAME)}</a>
				</div>
			</div>
		</div>
	</div>
