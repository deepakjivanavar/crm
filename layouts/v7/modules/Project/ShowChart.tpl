...
{if !empty($PROJECT_TASKS['tasks'])}
    ...
    <br />
    <br />
    <input id="projecttasks"  type="hidden" value="{nectarcrm_Util_Helper::toSafeHTML(Zend_Json::encode($PROJECT_TASKS))}">
    <input id="originalprojecttasks" type="hidden" value="{nectarcrm_Util_Helper::toSafeHTML(Zend_Json::encode($PROJECT_TASKS))}">
...
{else} 
    <table class="emptyRecordsDiv">
		<tbody>
			<tr>
				<td>
                    {assign var="PROJECT_TASK_MODEL" value=nectarcrm_Module_Model::getInstance('ProjectTask')}
