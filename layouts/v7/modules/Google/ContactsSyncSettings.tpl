                                ...
                                <tr>
                                    <td>
                                        {if $CUSTOM_FIELD_MAP['google_field_name'] eq 'gd:email'}
                                            <select class="select2 stretched nectarcrm_field_name col-sm-12" data-category="email">
                                        ...
                                        {else if $CUSTOM_FIELD_MAP['google_field_name'] eq 'gd:phoneNumber'}
                                            <select class="select2 stretched nectarcrm_field_name col-sm-12" data-category="phone">
                                        ...
                                        {else if $CUSTOM_FIELD_MAP['google_field_name'] eq 'gContact:userDefinedField'}
                                            <select class="select2 stretched nectarcrm_field_name col-sm-12" data-category="custom">
                                        ...
                                        {else if $CUSTOM_FIELD_MAP['google_field_name'] eq 'gContact:website'}
                                            <select class="select2 stretched nectarcrm_field_name col-sm-12" data-category="url">
