...
nectarcrm_RelatedList_Js("Campaigns_RelatedList_Js",{
	...
	postLoadRelatedListViewRecords : function(){
		...
		app.event.off('nectarcrm.RelatedList.PostLoad.Event');
		app.event.on('nectarcrm.RelatedList.PostLoad.Event', function(e) {
			var listParams = {
