		...
		<form class="form-horizontal" name="step1" method="post" action="index.php">
			...
			<div class="row">
				<div class="col-sm-4 welcome-image">
					<img src="{'wizard_screen.png'|vimage_path}" alt="nectarcrm Logo"/>
				</div>
				<div class="col-sm-8">
					<div class="welcome-div">
						<h3>{vtranslate('LBL_WELCOME_TO_NECTARCRM7_SETUP_WIZARD', 'Install')}</h3>
						{vtranslate('LBL_NECTARCRM7_SETUP_WIZARD_DESCRIPTION','Install')}
					</div>
