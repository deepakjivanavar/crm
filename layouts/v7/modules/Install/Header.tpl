...
{strip}
	...
	<html>
		...
		<body style="font-size: 13px !important;" data-skinpath="{nectarcrm_Theme::getBaseThemePath()}" data-language="{$LANGUAGE}" data-user-decimalseparator="{$CURRENT_USER_MODEL->get('currency_decimal_separator')}" data-user-dateformat="{$CURRENT_USER_MODEL->get('date_format')}"
