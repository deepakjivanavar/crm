...
{strip}
	...
	{assign var=SELECTED_PICKLIST_FIELDMODEL value= nectarcrm_Field_Model::getInstance('taskstatus', $MODULE_MODEL)}
		...
		<div class="entries ui-draggable">
			...
			<div class="task clearfix" data-recordid="{$RECORD_MODEL->get('id')}" data-priority="{$PRIORITY}" data-basicinfo='{json_encode($RECORD_BASIC_INFO)}' style="border-left:4px solid {$COLORS[$PRIORITY]}">
				...
				<div class='task-body clearfix'>
					...
					{assign var=SELECTED_PICKLISTFIELD_ALL_VALUES value= nectarcrm_Util_Helper::getPickListValues('taskstatus')}
				...
				<div class='other-details clearfix'>
					...
					<div class="task-details">
						<span class='taskDueDate'>
							<i class="fa fa-calendar"></i>&nbsp;<span style="vertical-align: middle">{nectarcrm_Date_UIType::getDisplayDateValue($RECORD_MODEL->get('due_date'))}</span>
						</span>
						...
						{if !empty($RELATED_PARENT)}
							<span class='related_account' style='margin-left: 8px;'>
								...
								<span style="font-size: 12px;">{nectarcrm_Module_Model::getModuleIconPath($RELATED_PARENT_MODULE)}&nbsp;</span>
						...
						{if !empty($RELATED_CONTACT['id'])}
							<span class='related_contact' style='margin-left: 8px;'>
								<span style="font-size: 12px;">{nectarcrm_Module_Model::getModuleIconPath('Contacts')}&nbsp;</span>
								<span class="recordName textOverflowEllipsis" style="vertical-align: middle">
