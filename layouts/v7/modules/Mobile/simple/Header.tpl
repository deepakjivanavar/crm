...
<html ng-app="mobileapp">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="../../{$TEMPLATE_WEBPATH}/resources/libs/nectarcrm-icons/style.css">
		...
		<script type="text/javascript" src="../../{$TEMPLATE_WEBPATH}/nectarcrm/js/application.js"></script>
		<script type="text/javascript" src="../../{$TEMPLATE_WEBPATH}/nectarcrm/js/nectarcrm.js"></script>
		<script type="text/javascript" src="../../{$TEMPLATE_WEBPATH}/nectarcrm/js/Utils.js"></script>
	...
	{literal}
		<body ng-controller="nectarcrmBodyController" ng-init="init();" ng-cloak md-theme="{{dynamicTheme}}" md-theme-watch>
	{/literal}
