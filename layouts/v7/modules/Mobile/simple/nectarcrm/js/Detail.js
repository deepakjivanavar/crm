mobileapp.controller('nectarcrmDetailController', function ($scope, $api) {
    var url = jQuery.url();
    ...
    $scope.loadRecord = function () {
        $api('fetchRecord', {module:$scope.module, record:$scope.record, view_mode:'web'}, function(e,r) {
            ...
            var processedData = [];
            var ignoreFields  = _NECTARCRM_RESTRICTIONS['nectarcrm']['View']['Detail']['Fields']['Ignore_Fields'];
