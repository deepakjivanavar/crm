...
* The Original Code is:  nectarcrm CRM Commercial
...
<script type="text/javascript" src="../../{$TEMPLATE_WEBPATH}/nectarcrm/js/Edit.js"></script>
{literal}

<form name="editForm" id="field-edit-form" ng-submit="saveThisRecord(editForm)" ng-controller="nectarcrmEditController">
