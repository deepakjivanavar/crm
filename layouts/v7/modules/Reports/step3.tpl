...
{strip}
    <form class="form-horizontal recordEditView" id="report_step3" method="post" action="index.php">
        ...
        <input type="hidden" name="reportname" value="{nectarcrm_Util_Helper::toSafeHTML($REPORT_MODEL->get('reportname'))}" />
        ...
        <input type="hidden" name="reports_description" value="{nectarcrm_Util_Helper::toSafeHTML($REPORT_MODEL->get('description'))}" />
