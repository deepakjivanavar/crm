 ...
 * All Rights Reserved.
 *************************************************************************************/
nectarcrm_AdvanceFilter_Js('Workflows_AdvanceFilter_Js',{},{
                            ...
                            if((fieldType == 'date' || fieldType == 'datetime') && valueSelectElement.length > 0) {
                                ...
                                for(i = 0; i < valueArray.length; i++) {
                                    ...
                                    if(!isNaN(dateInstance.getTime())) {
                                        valueArray[i] = app.getDateInnectarcrmFormat('yyyy-mm-dd', dateInstance);
                                    }
                                }
...
nectarcrm_Field_Js('Workflows_Field_Js',{},{
...
nectarcrm_Date_Field_Js('Workflows_Date_Field_Js',{},{
    ...
    getUi : function() {
        ...
        if(comparatorSelectedOptionVal.length > 0) {
            if(comparatorSelectedOptionVal == 'between' || comparatorSelectedOptionVal == 'custom'){
                ...
                var html = '<input name="'+ this.getName() +'" type="text" value="'+this.getValue()+'" data-validation-engine="validate[funcCall[nectarcrm_Base_Validator_Js.invokeValidation]]" data-validator="[{"name":"PositiveNumber"}]">\n\
							<input type="hidden" name="valuetype" value="'+this.get('workflow_valuetype')+'" />';
                return jQuery(html);
...
nectarcrm_Date_Field_Js('Workflows_Datetime_Field_Js',{},{
    /**
	 * Function to get the user date format
	 */
    getDateFormat : function(){
...
nectarcrm_Currency_Field_Js('Workflows_Currency_Field_Js',{},{
...
nectarcrm_Time_Field_Js('Workflows_Time_Field_Js',{},{
...
nectarcrm_Field_Js('nectarcrm_Percentage_Field_Js',{},{
...
nectarcrm_Field_Js('nectarcrm_Text_Field_Js',{},{
...
nectarcrm_Field_Js('nectarcrm_Boolean_Field_Js',{},{
...
nectarcrm_Owner_Field_Js('Workflows_Owner_Field_Js',{},{
...
nectarcrm_Owner_Field_Js('Workflows_Ownergroup_Field_Js',{},{
	getUi : function() {
...
nectarcrm_Picklist_Field_Js('Workflows_Picklist_Field_Js',{},{
...
nectarcrm_Multipicklist_Field_Js('Workflows_Multipicklist_Field_Js', {}, {
