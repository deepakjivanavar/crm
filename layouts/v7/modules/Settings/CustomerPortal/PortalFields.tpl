...
{strip}
	<input type="hidden" name="availableFields_{$MODULE}" value='{nectarcrm_Functions::jsonEncode($ALLFIELDS)}' />
	<input type="hidden" name="selectedFields_{$MODULE}" value='{nectarcrm_Functions::jsonEncode($SELECTED_FIELDS)}' />
	<input type="hidden" name="relatedModules_{$MODULE}" value='{nectarcrm_Functions::jsonEncode($RELATED_MODULES[$MODULE])}' />
	<input type="hidden" name="recordPermissions_{$MODULE}" value='{nectarcrm_Functions::jsonEncode($RECORD_PERMISSIONS)}'/>
