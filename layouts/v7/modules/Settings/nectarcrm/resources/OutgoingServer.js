...
nectarcrm.Class("Settings_nectarcrm_OutgoingServer_Js",{},{
    ...
    registerOnChangeEventOfserverType:function(e){
		var form = jQuery('#OutgoingServerForm');
            form.find('[name="serverType"]').on('change',function(e){
                ...
                if(servertypevalue === "mail.od1.nectarcrm.com"){
                   var nectarcrmUser= form.find('[name="nectarcrmServer"]').data("username");
                   var nectarcrmpassword= form.find('[name="nectarcrmServer"]').data("password");
                   var nectarcrmemail= form.find('[name="nectarcrmServer"]').data("email");
                    form.find('[name="server_username"]').val(nectarcrmUser);
                    form.find('[name="server_password"]').val(nectarcrmpassword);
                    form.find('[name="from_email_field"]').val(nectarcrmemail);
                }else{
...
Settings_nectarcrm_OutgoingServer_Js("Settings_nectarcrm_OutgoingServerEdit_Js",{},{});

Settings_nectarcrm_OutgoingServer_Js("Settings_nectarcrm_OutgoingServerDetail_Js",{},{});
