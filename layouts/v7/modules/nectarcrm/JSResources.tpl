...
{strip}
    ...
    <script type="text/javascript" src="layouts/v7/lib/jquery/jquery-validation/additional-methods.js"></script>
    ...
    <script type="text/javascript" src="{vresource_url('layouts/v7/modules/nectarcrm/resources/Class.js')}"></script>
    ...
    <script type="text/javascript" src="{vresource_url('layouts/v7/modules/nectarcrm/resources/Utils.js')}"></script>
    <script type='text/javascript' src="{vresource_url('layouts/v7/modules/nectarcrm/resources/validation.js')}"></script>
    <script type="text/javascript" src="{vresource_url('layouts/v7/lib/bootbox/bootbox.js')}"></script>
    <script type="text/javascript" src="{vresource_url('layouts/v7/modules/nectarcrm/resources/Base.js')}"></script>
    <script type="text/javascript" src="{vresource_url('layouts/v7/modules/nectarcrm/resources/nectarcrm.js')}"></script>
    ...
    <script type="text/javascript" src="{vresource_url('layouts/v7/modules/nectarcrm/resources/CkEditor.js')}"></script>
	...
	<script type="text/javascript">
        ...
        {***** Edited by Nilesh (Email Duplicate remove method) ****}

        jQuery.validator.addMethod( "notEqualTo", function( value, element, param ) {
            return this.optional( element ) || !jQuery.validator.methods.equalTo.call( this, value, element, param );
        }, "Please enter a different value, values must not be the same." );

        {***** EOF Edited by Nilesh ****}
