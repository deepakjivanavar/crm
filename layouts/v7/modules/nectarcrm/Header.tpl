...
<html>
	<head>
        ...
        {assign var=V7_THEME_PATH value=nectarcrm_Theme::getv7AppStylePath($SELECTED_MENU_CATEGORY)}
	...
	<body data-skinpath="{nectarcrm_Theme::getBaseThemePath()}" data-language="{$LANGUAGE}" data-user-decimalseparator="{$CURRENT_USER_MODEL->get('currency_decimal_separator')}" data-user-dateformat="{$CURRENT_USER_MODEL->get('date_format')}"
