...
var vtUtils = {
    ...
    showQtip : function(element,message,customParams) {
        ...
        var qtipParams =  {
            ...
            show: {
                event: 'nectarcrm.Qtip.ShowMesssage'
            },
            hide: {
                event: 'nectarcrm.Qtip.HideMesssage'
            }
        };
        jQuery.extend(qtipParams,customParams);

        element.qtip(qtipParams);
        element.trigger('nectarcrm.Qtip.ShowMesssage');
    },

    hideQtip : function(element) {
        element.trigger('nectarcrm.Qtip.HideMesssage');
    },
