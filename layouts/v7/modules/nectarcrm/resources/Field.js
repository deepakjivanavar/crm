 ...
 * All Rights Reserved.
 *************************************************************************************/
jQuery.Class("nectarcrm_Field_Js",{
	...
	getInstance : function(data,moduleName){
		...
		if (typeof moduleFieldObj != 'undefined'){
			...
			var fieldClass = nectarcrm_Field_Js;
		}
	...
	getUiTypeModel : function() {
		...
		var BasicUiTypeClassName = window["nectarcrm_"+ typeClassName + "_Field_Js"];
...
nectarcrm_Field_Js('nectarcrm_Reference_Field_Js',{},{
...
nectarcrm_Field_Js('nectarcrm_Picklist_Field_Js',{},{
...
nectarcrm_Field_Js('nectarcrm_Currencylist_Field_Js',{},{
...
nectarcrm_Field_Js('nectarcrm_Multipicklist_Field_Js',{},{
	/**
	 * Function to get the pick list values
	 * @return <object> key value pair of options
	 */
...
nectarcrm_Field_Js('nectarcrm_Date_Field_Js',{},{
...
nectarcrm_Field_Js('nectarcrm_Currency_Field_Js',{},{
...
nectarcrm_Field_Js('nectarcrm_Owner_Field_Js',{},{
...
nectarcrm_Date_Field_Js('nectarcrm_Datetime_Field_Js',{},{

});

nectarcrm_Field_Js('nectarcrm_Time_Field_Js',{},{
...
nectarcrm_Field_Js('nectarcrm_Recurrence_Field_Js',{},{
...
nectarcrm_Field_Js('nectarcrm_Email_Field_Js',{},{
...
nectarcrm_Field_Js('nectarcrm_Image_Field_Js',{},{
...
nectarcrm_Field_Js('nectarcrm_Integer_Field_Js',{},{
	getUi : function() {
		var html = '<input class="inputElement" type="text" name="'+ this.getName() +'" data-label="'+this.get('label')+'" data-rule-'+this.getType()+'=true />';
		html = jQuery(html).val(app.htmlDecode(this.getValue()));
		return this.addValidationToElement(html);
