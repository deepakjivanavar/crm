...
nectarcrm.Class('nectarcrm_Widget_Js',{

	widgetPostLoadEvent : 'Vtiget.Dashboard.PostLoad',
	widgetPostRefereshEvent : 'nectarcrm.Dashboard.PostRefresh',
    widgetPostResizeEvent : 'nectarcrm.DashboardWidget.PostResize',
	...
	getInstance : function(container, widgetName, moduleName) {
		...
		var fallbackClass = window["nectarcrm_"+widgetClassName+"_Widget_Js"];
		var basicClass = nectarcrm_Widget_Js;
...
//			this.positionNoDataMsg();
	...
	refreshWidget : function() {
		...
		app.request.post(params).then(
			function(err,data){
				...
				contentContainer.trigger(nectarcrm_Widget_Js.widgetPostRefereshEvent);
			}
		);
	},
	...
	registerWidgetPostLoadEvent : function(container) {
		var thisInstance = this;
		container.off(nectarcrm_Widget_Js.widgetPostLoadEvent).on(nectarcrm_Widget_Js.widgetPostLoadEvent, function(e) {
	...
	registerWidgetPostRefreshEvent : function(container) {
		var thisInstance = this;
		container.on(nectarcrm_Widget_Js.widgetPostRefereshEvent, function(e) {
    ...
    registerWidgetPostResizeEvent : function(container){
        var thisInstance = this;
		container.on(nectarcrm_Widget_Js.widgetPostResizeEvent, function(e) { 
...
nectarcrm_Widget_Js('nectarcrm_KeyMetrics_Widget_Js', {}, {
    postLoadWidget: function() {
		this._super();
		var widgetContent = jQuery('.dashboardWidgetContent', this.getContainer());
...
nectarcrm_Widget_Js('nectarcrm_TopPotentials_Widget_Js', {}, {
...
nectarcrm_Widget_Js('nectarcrm_History_Widget_Js', {}, {
...
nectarcrm_Widget_Js('nectarcrm_Funnel_Widget_Js',{},{
...
nectarcrm_Widget_Js('nectarcrm_Pie_Widget_Js',{},{
...
nectarcrm_Widget_Js('nectarcrm_Barchat_Widget_Js',{},{
...
nectarcrm_Widget_Js('nectarcrm_MultiBarchat_Widget_Js',{
...
nectarcrm_Widget_Js('nectarcrm_MiniList_Widget_Js', {
...
nectarcrm_Widget_Js('nectarcrm_TagCloud_Widget_Js',{},{
...
/* Notebook Widget */
nectarcrm_Widget_Js('nectarcrm_Notebook_Widget_Js', {
...
nectarcrm_History_Widget_Js('nectarcrm_OverdueActivities_Widget_Js', {}, {
...
nectarcrm_OverdueActivities_Widget_Js('nectarcrm_CalendarActivities_Widget_Js', {}, {});
