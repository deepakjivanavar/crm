					...
					<div class="row email-info-row">
						...
						<div class="col-lg-10">
							<div class="email-body-preview">
								...
								<iframe frameBorder="0" scrolling='yes' id="emailPreviewIframe" style='width: 100%; ::-webkit-scrollbar {
						...
						<span class="col-lg-12" style="text-align: center;">
							<span class="muted">
								{if $RECORD->get('email_flag') eq "SAVED"}
									...
									<span><small><em>&nbsp;{nectarcrm_Util_Helper::formatDateTimeIntoDayString($RECORD->get('createdtime'))}</em></small></span>
								{else}
									...
									<span><small><em>&nbsp;{nectarcrm_Util_Helper::formatDateTimeIntoDayString($SEND_TIME)}</em></small></span>
								{/if}
							</span>
						</span>
					</div>
