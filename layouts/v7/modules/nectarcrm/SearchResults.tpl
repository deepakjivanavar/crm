...
{strip}
	<script type="text/javascript" src="{vresource_url('layouts/v7/modules/nectarcrm/resources/List.js')}"></script>
	<script type="text/javascript" src="{vresource_url('layouts/v7/modules/nectarcrm/resources/SearchList.js')}"></script>
