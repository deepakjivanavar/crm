	...
	<div id="sidebar" class="col-lg-3">
		...
		<div id="modnavigator" class="row module-nav">
			<div class="hidden-xs hidden-sm mod-switcher-container">
				{include file="modules/nectarcrm/partials/Menubar.tpl"}
				{include file="modules/nectarcrm/partials/SidebarEssentials.tpl"}
			</div>
		</div>
		<div class="app-menu hide" id="app-menu">
			<div class="container-fluid">
				<div class="row moduleList">
					...
					{assign var=REPORT_MODULE_MODEL value=nectarcrm_Module_Model::getInstance('Reports')}
					<div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
						<div class="menu-item" style="background: #FDE3A7;"data-url="{$REPORT_MODULE_MODEL->getDefaultUrl()}">Reports</div>
					</div>
					{if $USER_MODEL->isAdminUser()}
						<div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
							<div class="menu-item" style="background: #ECF0F1;" data-url="index.php?module=nectarcrm&parent=Settings&view=Index">{vtranslate('LBL_CRM_SETTINGS',$MODULE)}</div>
						</div>
						<div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
