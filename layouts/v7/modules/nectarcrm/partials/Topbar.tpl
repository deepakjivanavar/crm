...
{strip}
	{include file="modules/nectarcrm/Header.tpl"}

	{assign var=APP_IMAGE_MAP value=nectarcrm_MenuStructure_Model::getAppIcons()}
	<nav class="navbar navbar-inverse navbar-fixed-top app-fixed-navbar" style="    box-shadow: 0px 0px 8px 2px grey;">
		<div class="container global-nav" style="width:100%;">
			<div class="row">
				<div class="col-lg-1 col-md-1 col-sm-4 col-xs-8 app-navigator-container">
						<div id="appnavigator" class="col-sm-2 col-xs-2 cursorPointer app-switcher-container" data-app-class="{if $MODULE eq 'Home' || !$MODULE}fa-dashboard{else}{$APP_IMAGE_MAP[$SELECTED_MENU_CATEGORY]}{/if}">
							<div align="left" class="row app-navigator" style=" background:transparent;">
								<span class="app-icon fa fa-bars" style="color:#000;"></span>
							</div>
						</div>
				</div>
				...
				<div id="navbar" class="col-md-6 col-xs-12 collapse navbar-collapse  global-actions">
					<ul class="nav navbar-nav">
						<li>
							<div class="dropdown pull-left">
								<div  class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
									<a href="#" id="menubar_quickCreate" class="qc-button fa fa-plus-circle" title="{vtranslate('LBL_QUICK_CREATE',$MODULE)}" aria-hidden="true"> Quick Create</a>
								</div>
															...
															{else if $singularLabel == 'SINGLE_Documents'}
																<div class="{if $hideDiv}create_restricted_{$moduleModel->getName()} hide{else}col-lg-4 col-xs-4{/if} dropdown">
																	...
																	<ul class="dropdown-menu quickcreateMoreDropdown" aria-labelledby="menubar_quickCreate_{$moduleModel->getName()}">
																		...
																		<li id="nectarcrmAction">
																			<a href="javascript:Documents_Index_Js.uploadTo('nectarcrm')">
																				<img style="  margin-top: -3px;margin-right: 4%;" title="nectarcrm" alt="nectarcrm" src="layouts/v7/skins//images/nectarcrm.png">
																				{vtranslate('LBL_TO_SERVICE', $moduleName, {vtranslate('LBL_nectarcrm', $moduleName)})}
																			</a>
																		</li>
						...
						{assign var=CALENDAR_MODULE_MODEL value=nectarcrm_Module_Model::getInstance('Calendar')}
						...
						{/if}
						{assign var=REPORTS_MODULE_MODEL value=nectarcrm_Module_Model::getInstance('Reports')}
						...
						{/if}
						{if $USER_PRIVILEGES_MODEL->hasModulePermission($CALENDAR_MODULE_MODEL->getId())}
							<li><div><a href="#" class="taskManagement vicon vicon-task" title="{vtranslate('Tasks','nectarcrm')}" aria-hidden="true"></a></div></li>
						{/if}
						<li class="dropdown">
							<div>
								<a href="#" class="userName dropdown-toggle pull-right" data-toggle="dropdown" role="button">
									...
									<span class="link-text-xs-only hidden-lg hidden-md hidden-sm">{$USER_MODEL->getName()}</span>
									 {$USER_MODEL->get('first_name')} {$USER_MODEL->get('last_name')} <span class="fa fa-caret-down" aria-hidden="true"></span>
										...
										<div class="col-lg-4 col-sm-4">
											<div class="profile-img-container">
												...
												{if $IMAGE_DETAILS neq '' && $IMAGE_DETAILS[0] neq '' && $IMAGE_DETAILS[0].path eq ''}
													<i class='vicon-nectarcrmuser' style="font-size:90px"></i>
												{else}
				...
				<div class="logo-container col-md-3 col-xs-9">
							<div class="row">
								<a href="index.php" class="company-logo">
								    
								    	<img src="layouts/v7/resources/Images/nectarcrm logo.png" style="margin-left:80px;">
