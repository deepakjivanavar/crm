			...
			{foreach key=_HEADER_NAME item=_FIELD_VALUE from=$ROW_1_DATA name="headerIterator"}
				...
				<tr class="fieldIdentifier" id="fieldIdentifier{$_COUNTER}">
					...
					<td>
						...
						<select name="mapped_fields" class="select2" id ="mappedFieldsSelect" style="width:100%" onchange="nectarcrm_Import_Js.loadDefaultValueWidget('fieldIdentifier{$_COUNTER}')">
