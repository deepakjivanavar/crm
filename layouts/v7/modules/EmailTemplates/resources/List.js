...
nectarcrm_List_Js("EmailTemplates_List_Js", {
	...
	addIndexComponent : function() {
		this.addModuleSpecificComponent('Index','nectarcrm','Settings');
	},
	
    
    /**
     * Function to override function written in nectarcrm List.js file to add extra parameter for
    ...
    registerEvents: function () {
        ...
        if(window.hasOwnProperty('Settings_nectarcrm_Index_Js')){
