...
nectarcrm_Email_Validator_Js("nectarcrm_To_Email_Validator_Js", {
	...
	invokeValidation: function(field, rules, i, options){
		var toEmailInstance = new nectarcrm_To_Email_Validator_Js();
	...
	validate: function() {
		...
		for (var i in fieldValuesList) {
			...
			var emailInstance = new nectarcrm_Email_Validator_Js();
...
jQuery.Class("Emails_MassEdit_Js",{},{
	...
	getckEditorInstance : function(){
		if(this.ckEditorInstance == false){
			this.ckEditorInstance = new nectarcrm_CkEditor_Js();
		}
	...
	fileAfterSelectHandler : function(element, value, master_element){
		...
		if(totalAttachmentsSize > maxUploadSize){
			nectarcrm_Helper_Js.showPnotify(app.vtranslate('JS_MAX_FILE_UPLOAD_EXCEEDS'));
