...
Reports_Detail_Js("Reports_ChartDetail_Js",{
	...
	registerEventForChartGeneration : function() {
		...
		try {
			...
			jQuery('#chartcontent').trigger(nectarcrm_Widget_Js.widgetPostLoadEvent);
		} catch(error) {
			console.log("error");
			console.log(error);
...
nectarcrm_Pie_Widget_Js('Report_Piechart_Js',{},{
...
nectarcrm_Barchat_Widget_Js('Report_Verticalbarchart_Js', {},{
