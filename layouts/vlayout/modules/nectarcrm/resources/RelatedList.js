            ...
            AppConnector.request(url).then(
				function(data){
					if(data){
                             ...
                             var params = {
                                        ...
                                        AppConnector.request(params).then(function(data){
                                            ...
                                            if(data['result'].created){
                                                ...
                                                nectarcrm_Detail_Js.reloadRelatedList();
                                            }
                                        });
                         });
                    });
                        ...
                        progressIndicatorInstance.hide();
                        nectarcrm_Helper_Js.showPnotify(app.vtranslate('JS_NO_EDIT_PERMISSION',"Calendar"));
                    }
				});
    },
                ...
                var params = {
                            ...
                            AppConnector.request(params).then(function(data){
                                if(data['error']){
                                    ...
                                    nectarcrm_Helper_Js.showPnotify(param);
                                }
