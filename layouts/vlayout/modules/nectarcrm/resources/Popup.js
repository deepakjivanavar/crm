 ...
 * All Rights Reserved.
 *************************************************************************************/
jQuery.Class("nectarcrm_Popup_Js",{
    ...
    getInstance: function(){
		...
		var fallbackClassName = nectarcrm_Popup_Js;
	...
	show : function(urlOrParams, cb, windowName, eventName, onLoadCb){
		...
		if(typeof cb != 'undefined') {
		 ...
		 if(typeof onLoadCb == 'function') {
			jQuery.windowMsg('nectarcrm.OnPopupWindowLoad.Event', function(data){
				onLoadCb(data);
            })
        }
	...
	getPageRecords : function(params){
		...
		nectarcrm_BaseList_Js.getPageRecords(params).then(
				function(data){
