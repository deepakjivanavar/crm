...
jQuery.Class("Settings_nectarcrm_ConfigEditor_Js",{},{
...
jQuery(document).ready(function(e){
	var tacInstance = new Settings_nectarcrm_ConfigEditor_Js();
	tacInstance.registerEvents();
})

nectarcrm_WholeNumberGreaterThanZero_Validator_Js("nectarcrm_NumberRange5_Validator_Js",{
	...
	invokeValidation: function(field, rules, i, options){
		var rangeInstance = new nectarcrm_NumberRange5_Validator_Js();
...
nectarcrm_WholeNumberGreaterThanZero_Validator_Js("nectarcrm_NumberRange100_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var rangeInstance = new nectarcrm_NumberRange100_Validator_Js();
		rangeInstance.setElement(field);
		var response = rangeInstance.validate();
		if(response != true){
			return rangeInstance.getError();
