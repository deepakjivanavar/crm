...
Settings_nectarcrm_Index_Js("Settings_PBXManager_Index_Js", {},{
    ...
    */
	...
	registerEditViewEvents : function() {
		...
		var form = jQuery('#MyModal');
                ...
                //To Auto-Generate nectarcrm Secret Key
                var url = 'index.php?module=PBXManager&parent=Settings&action=Gateway&mode=getSecretKey';
                 AppConnector.request(url).then(
                    function(data) {
                        jQuery("input[name='nectarcrmsecretkey']").attr("value",data.result);
                    }
                 );
		//END
