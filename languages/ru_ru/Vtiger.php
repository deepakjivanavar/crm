...
$languageStrings = array(
	...
	'POWEREDBY'                    => 'Создано nectarcrm CRM'       ,
...
                                           Например, для преобразования телефонного номера США (415 599 2671) в формат E.164, нужно было бы добавить \'+\' префикс и код страны (что 1) в передней части числа (+1 415 599 2671 ). В Великобритании и многих других стран на международном уровне, местные функции требуется добавление 0 перед номером абонента. Однако, чтобы использовать форматирование E.164, это 0 должны быть удалены. Ряд таких как 020 7183 8750 в Великобритании будут отформатированы как +44 20 7183 8750.',
	...
	'vt_create' => 'nectarcrm Создано',
	'vt_update' => 'nectarcrm Обновлено',
	'vt_delete' => 'nectarcrm удаленных',
	'vt_skip' => 'nectarcrm Пропущено',
...
снаружи вольная русская.',
  ...
  'LBL_SOCIAL_LINKED' => 'Вашего nectarcrm теперь привязан к',
  ...
  'LBL_TO_USE_SWITCH_TO_NEW_LOOK' => 'Для использования <B>%s</B>, мы рекомендуем вам перейти на новый облик.',
	...
	'LBL_DUPLICATES_FOUND_MESSAGE' => 'Это%s не может быть сохранен, так как дубликат%s существует в nectarcrm с соответствующими значениями для% с.',
	'LBL_NECTARCRM_NOTIFICATION' => 'Сообщение от: nectarcrm системы уведомлений',
...
$jsLanguageStrings = array(
    ...
    'JS_CURRENCY_TOOLTIP_CONTENT_MESSAGE' => 'Валютные ценности в очереди за импортом предметов, nectarcrm будет использовать этот параметр, чтобы определить валюту. Любые валютные ценности за пределами таблиц позиций, предполагаются в разделе Пользователи предпочитают валюты (выбирается в моих предпочтениях)',
	...
	'JS_SUITABLE_NECTARCRM_FIELD_NOT_AVAILABLE_FOR_MAPPING' => 'Подходит поле nectarcrm не доступны для отображения',
    ...
    'OFFICE365_REMOVE_SYNCHRONIZATION_MESSAGE' => 'Нажатие на это будет удалить существующий аутентификацию Office365. Это не будет удалять какие-либо записи, которые уже синхронизированы. Он не будет отменять регистрацию приложение nectarcrm от вас Office365 счет, отменить посетить https://myapps.microsoft.com/',
  ...
  'JS_MORE_NECTARCRM' => 'Есть несколько записей, чтобы быть синхронизированы в вольная русская',
