...
$languageStrings = array(
	...
	'POWEREDBY'=> 'Wspierane przez nectarcrm CRM',
	...
	'LBL_CUSTOM_VIEW_NAME_DUPLICATES_EXIST' => 'Lista już istnieje',
        'LBL_EXPORT_CURRENCY_TOOLTIP_TEXT'=>'Eksportu wartości waluty, w pozycje, nectarcrm użyje tego ustawienia do eksportu, jak tej walucie. Wszelkie wartości waluty poza tabelach pozycje, będą wywożone w preferowanej walucie (Users wybranego w moje preferencje)',
	...
	'LBL_NECTARCRM_CRM_HONEST_OPEN_SOURCE' => 'nectarcrm CRM Honest Open Source',
...
                                   Na przykład, w przypadku przeglądania komentarzy na płycie Organization, komentarze dodane do powiązanych kontaktów, szans, biletów, ..etc będą również wyświetlane.",
	...
	'vt_create' => 'nectarcrm Utworzono',
	'vt_update' => 'nectarcrm Zaktualizowano',
	'vt_delete' => 'nectarcrm Usunięte',
	'vt_skip' => 'Pominięte nectarcrm',
...
na zewnątrz free rosyjska.',
  ...
  'LBL_SOCIAL_LINKED' => 'Twój nectarcrm teraz przywiązany do',
  ...
  'LBL_TO_USE_SWITCH_TO_NEW_LOOK' => 'Aby korzystać <b>%s</ b>, zalecamy, aby przełączyć na nowy wygląd.',
	...
	'LBL_DUPLICATES_FOUND_MESSAGE' => 'Ten%s nie może zostać zapisany, ponieważ duplikat%s istnieje w nectarcrm z pasującymi wartości dla%s.',
	'LBL_NECTARCRM_NOTIFICATION' => 'Wiadomość od: nectarcrm Systemu Zgłoszeń',
...
$jsLanguageStrings = array(
    ...
    'JS_CURRENCY_TOOLTIP_CONTENT_MESSAGE' => 'Wartości waluty w kolejce do importowania elementów, nectarcrm użyje tego ustawienia, aby określić walutę. Wszelkie wartości waluty poza tabelach pozycje, są uznawane za korzystne w walucie Users (wybrany w moje preferencje)',
	...
	'JS_SUITABLE_NECTARCRM_FIELD_NOT_AVAILABLE_FOR_MAPPING' => 'Odpowiednie pola nectarcrm niedostępne dla mapowania',
    ...
    'OFFICE365_REMOVE_SYNCHRONIZATION_MESSAGE' => 'Kliknięcie na ten usunie istniejące uwierzytelniania Office365. To nie usunie żadnych zapisów, które są już zsynchronizowane. Nie będzie wyrejestrować aplikację nectarcrm od Ciebie office365 uwagę, aby wyrejestrować odwiedzić https://myapps.microsoft.com/',
  ...
  'LBL_DELETE_USER_CONFIRMATION' => 'Gdy użytkownik zostanie usunięty, użytkownik będzie oznaczony jako "nie aktywny" i żadnych nowych rekordów mogą być przypisane użytkownikowi, a użytkownik nie będzie mógł zalogować się do systemu. Fakturowanie będzie przystanek dla danego użytkownika.Jeśli potrzebujesz, aby umożliwić zdalny użytkownik, trzeba będzie wysłać e-mail support@nectarcrm.com.Are jesteś pewien, że chcesz usunąć?',
  ...
  'JS_MORE_NECTARCRM' => 'Istnieje kilka pozycji, aby być zsynchronizowane w free rosyjska',
