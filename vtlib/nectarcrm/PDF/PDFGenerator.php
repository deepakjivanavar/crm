...
class nectarcrm_PDF_Generator {
	...
	function __construct() {
		$this->pdf = new nectarcrm_PDF_TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT);
	...
	function createLastPage() {
		...
		if ($totalHeightFooter) {
			$this->footerFrame = new nectarcrm_PDF_Frame();
	...
	function createPage($isLastPage = false) {
		...
		if ($totalHeightHeader) {
			$this->headerFrame = new nectarcrm_PDF_Frame();
		...
		// ContentViewer
		$this->contentFrame = new nectarcrm_PDF_Frame();
