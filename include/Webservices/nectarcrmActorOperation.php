...
require_once 'include/Webservices/nectarcrmCRMActorMeta.php';
class nectarcrmActorOperation extends WebserviceEntityOperation {
	...
	protected function getMetaInstance(){
		if(empty(WebserviceEntityOperation::$metaCache[$this->webserviceObject->getEntityName()][$this->user->id])){
			WebserviceEntityOperation::$metaCache[$this->webserviceObject->getEntityName()][$this->user->id]  
					= new nectarcrmCRMActorMeta($this->entityTableName,$this->webserviceObject,$this->pearDB,$this->user);
		}
	...
	protected function getActorTables(){
		...
		$sql = 'select table_name, webservice_entity_id from nectarcrm_ws_entity_tables';
	...
	public function __create($elementType,$element){
		...
		//Insert into group nectarcrm_table
