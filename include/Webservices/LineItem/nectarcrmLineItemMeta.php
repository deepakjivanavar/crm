...
/**
 * Description of nectarcrmLineItemMeta
 */
class nectarcrmLineItemMeta extends nectarcrmCRMActorMeta {
	...
	private function getTaxLabelFromName($name){
		...
		$sql = 'SELECT * FROM nectarcrm_inventorytaxinfo WHERE taxname=? AND deleted=0';
		$params = array($name);
