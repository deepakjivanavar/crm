...
class GetUserGroups { 
	...
	function getAllUserGroups($userid)
	{
		...
		$query="select * from nectarcrm_users2group where userid=?";
		...
		//Retreiving from the nectarcrm_user2role
		$query="select * from nectarcrm_group2role where roleid=?";
		...
		$query="select * from nectarcrm_group2rs where roleandsubid in (". generateQuestionMarks($parentRolelist) .")";
