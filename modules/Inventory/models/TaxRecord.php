...
class Inventory_TaxRecord_Model extends nectarcrm_Base_Model {

	const INVENTORY_TAXES_TABLE_NAME = 'nectarcrm_inventorytaxinfo';
	const CHARGES_TAX_TABLE_NAME = 'nectarcrm_shippingtaxinfo';
	...
	public function getCreateTaxUrl() {
		return '?module=nectarcrm&parent=Settings&view=TaxAjax&mode=editTax';
	}

	public function getEditTaxUrl() {
		return '?module=nectarcrm&parent=Settings&view=TaxAjax&mode=editTax&type='.$this->getType().'&taxid='.$this->getId();
	}
