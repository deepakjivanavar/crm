...
class Inventory_TaxRegion_Model extends nectarcrm_Base_Model {

	const REGIONS_TABLE_NAME = 'nectarcrm_taxregions';
	...
	public function getEditRegionUrl() {
		return '?module=nectarcrm&parent=Settings&view=TaxAjax&mode=editTaxRegion&taxRegionId='.$this->getId();
	}

	public function getDeleteRegionUrl() {
		return '?module=nectarcrm&parent=Settings&action=TaxAjax&mode=deleteTaxRegion&taxRegionId='.$this->getId();
	}
	...
	public function save() {
		...
		nectarcrm_Cache::flushPicklistCache('regionid');
		return $this->getId();
	}
