...
class nectarcrm_Base_UIType extends nectarcrm_Base_Model {
	...
	/**
	 * Static function to get the UIType object from nectarcrm Field Model
	 * @param nectarcrm_Field_Model $fieldModel
	 * @return nectarcrm_Base_UIType or UIType specific object instance
	 */
	public static function getInstanceFromField($fieldModel) {
		...
		$uiTypeClassName = 'nectarcrm_'.$uiTypeClassSuffix.'_UIType';
		$fallBackClassName = 'nectarcrm_Base_UIType';

		$moduleSpecificFileName = 'modules.'. $moduleName .'.uitypes.'.$uiTypeClassSuffix;
		$uiTypeClassFileName = 'modules.nectarcrm.uitypes.'.$uiTypeClassSuffix;

		$moduleSpecificFilePath = nectarcrm_Loader::resolveNameToPath($moduleSpecificFileName);
		$completeFilePath = nectarcrm_Loader::resolveNameToPath($uiTypeClassFileName);
