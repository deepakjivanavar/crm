...
/**
 * nectarcrm Summary View Record Structure Model
 */
class nectarcrm_SummaryRecordStructure_Model extends nectarcrm_DetailRecordStructure_Model {
	...
	public function getStructure() {
		...
		if(empty($summaryFieldsList)) {
			...
			if($fieldModuleModel->getName() == 'Events') {
				$fieldModuleModel = nectarcrm_Module_Model::getInstance('Calendar');
			}
