...
/**
 * nectarcrm MenuStructure Model
 */
class nectarcrm_MenuStructure_Model extends nectarcrm_Base_Model {
	 ...
	 * @return <array> - list of nectarcrm_Menu_Model instances
	 */
	 ...
	 * @return <array> - Associate array of Parent name mapped to nectarcrm_Menu_Model instances
	 */
	...
	/**
	 * Function to get an instance of the nectarcrm MenuStructure Model from list of menu models
	 * @param <array> $menuModelList - array of nectarcrm_Menu_Model instances
	 * @return nectarcrm_MenuStructure_Model instance
	 */
	public static function getInstanceFromMenuList($menuModelList, $selectedMenu='') {
		...
		foreach ($menuListArray[self::MORE_MENU_INDEX] as $parent => &$values) {
			uksort($values, array('nectarcrm_MenuStructure_Model', 'sortMenuItemsByProcess'));
		}
		//uksort($menuListArray[self::TOP_MENU_INDEX], array('nectarcrm_MenuStructure_Model', 'sortMenuItemsByProcess'));
	...
	function regroupMenuByParent($menuGroupedByParent) {
		...
		$oldToNewAppMap = nectarcrm_MenuStructure_Model::getOldToNewAppMapping();
