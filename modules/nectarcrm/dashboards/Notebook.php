...
class nectarcrm_Notebook_Dashboard extends nectarcrm_IndexAjax_View {
	...
	public function process(nectarcrm_Request $request, $widget=NULL) {
		...
		$widget = nectarcrm_Notebook_Model::getUserInstance($widgetId);
	...
	protected function getKeyMetricsWithCount() {
		...
		foreach ($metriclists as $key => $metriclist) {
			...
			if($metriclist['module'] == "Calendar") {
				...
				$metricresult = $adb->query(nectarcrm_Functions::mkCountQuery($metricsql));
			} else {
