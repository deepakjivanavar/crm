...
class nectarcrm_MiniList_Dashboard extends nectarcrm_IndexAjax_View {

	public function process(nectarcrm_Request $request, $widget=NULL) {
		...
		$widget = nectarcrm_Widget_Model::getInstanceWithWidgetId($widgetId, $currentUser->getId());

		$minilistWidgetModel = new nectarcrm_MiniList_Model();
