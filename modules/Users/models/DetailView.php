...
class Users_DetailView_Model extends nectarcrm_DetailView_Model {
	...
	public function getDetailViewLinks($linkParams) {
		...
		if (($currentUserModel->isAdminUser() == true || $currentUserModel->get('id') == $recordId) && $recordModel->get('status') == 'Active' ) {
			...
			foreach ($detailViewPreferenceLinks as $detailViewLink) {
				$linkModelList['DETAILVIEWPREFERENCE'][] = nectarcrm_Link_Model::getInstanceFromValues($detailViewLink);
			}
			...
			foreach ($detailViewActionLinks as $detailViewLink) {
				$linkModelList['DETAILVIEW'][] = nectarcrm_Link_Model::getInstanceFromValues($detailViewLink);
			}
