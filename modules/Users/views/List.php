...
class Users_List_View extends Settings_nectarcrm_List_View {
	...
	public function initializeListViewContents(nectarcrm_Request $request, nectarcrm_Viewer $viewer) {
		...
		if($request->get('mode') == 'removeAlphabetSearch') {
			nectarcrm_ListView_Model::deleteParamsSession($moduleName.'_'.$cvId, array('search_key', 'search_value', 'operator'));
			$searchKey = '';
			$searchValue = '';
			$operator = '';
		}
	...
	public function setModuleInfo($request, $moduleModel){
		...
		$listViewModel = nectarcrm_ListView_Model::getInstance($moduleModel->getName()); 
