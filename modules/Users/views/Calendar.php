 ...
 * All Rights Reserved.
 *************************************************************************************/
class Users_Calendar_View extends nectarcrm_Detail_View {
	...
	public function initializeView($viewer,nectarcrm_Request $request){
		$recordId = $request->get('record');
		$currentUserModel = Users_Record_Model::getCurrentUserModel();
...
//		$viewer->assign('ALL_USERS',$allUsers);
	...
	public function calendarSettingsEdit(nectarcrm_Request $request){
		$viewer = $this->getViewer($request);
	...
	public function calendarSettingsDetail(nectarcrm_Request $request){
		$viewer = $this->getViewer($request);
		$this->initializeView($viewer,$request);
	...
	/*
	 * HTTP REFERER check was removed in Parent class nectarcrm_Detail_View, because of 
