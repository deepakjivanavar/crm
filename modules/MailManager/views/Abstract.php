...
abstract class MailManager_Abstract_View extends nectarcrm_Index_View {
	 ...
	 */
	public function getViewer(nectarcrm_Request $request) {
	 ...
	 * @return type
	 */
	public function getOperationArg(nectarcrm_Request $request) {
