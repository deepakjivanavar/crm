...
class Documents_ListView_Model extends nectarcrm_ListView_Model {
	...
	public function getListViewMassActions($linkParams) {
		...
		if ($currentUserModel->hasModuleActionPermission($moduleModel->getId(), 'Delete')) {
			$massActionLink = array(
				...
				'linkurl' => 'javascript:nectarcrm_List_Js.massDeleteRecords("index.php?module=' . $moduleModel->getName() . '&action=MassDelete");',
				'linkicon' => ''
			);
