...
class SMSNotifierBase extends CRMEntity {
	...
	var $table_name = 'nectarcrm_smsnotifier';
	 ...
	 */
	var $customFieldTable = Array('nectarcrm_smsnotifiercf', 'smsnotifierid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('nectarcrm_crmentity', 'nectarcrm_smsnotifier', 'nectarcrm_smsnotifiercf');
	...
	var $tab_name_index = Array(
		...
		'nectarcrm_smsnotifier' => 'smsnotifierid',
		'nectarcrm_smsnotifiercf'=>'smsnotifierid');
	...
	function vtlib_handler($modulename, $event_type) {
        ...
        $SMSNotifierModule  = nectarcrm_Module::getInstance('SMSNotifier');
        nectarcrm_Access::setDefaultSharing($SMSNotifierModule);
		...
		if($unregisterLinks) {
			...
			$smsnotifierModuleInstance = nectarcrm_Module::getInstance('SMSNotifier');
