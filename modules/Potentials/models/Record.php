...
class Potentials_Record_Model extends nectarcrm_Record_Model {
	...
	function getConvertPotentialMappedField($fieldName, $moduleName) {
		...
		if (!$mappingFields) {
			...
			$result = $db->pquery('SELECT * FROM nectarcrm_convertpotentialmapping', array());
			$numOfRows = $db->num_rows($result);

			$projectInstance = nectarcrm_Module_Model::getInstance('Project');
