...
class Potentials_GroupedBySalesStage_Dashboard extends nectarcrm_IndexAjax_View {
	...
	public function process(nectarcrm_Request $request) {
		...
		if(!empty($dates)) {
			$dates['start'] = nectarcrm_Date_UIType::getDBInsertedValue($dates['start']);
			$dates['end'] = nectarcrm_Date_UIType::getDBInsertedValue($dates['end']);
		}
