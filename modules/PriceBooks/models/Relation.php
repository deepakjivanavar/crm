...
class PriceBooks_Relation_Model extends nectarcrm_Relation_Model{
	...
	public function getQuery($recordModel, $actions=false){
		...
		if(($functionName == 'get_pricebook_products') || ($functionName ==  'get_pricebook_services')){
			$selectColumnSql = $selectColumnSql.', nectarcrm_pricebookproductrel.listprice';
		}
	...
	public function addListPrice($sourceRecordId, $destinationRecordId, $listPrice) {
		...
		$priceBookModel = nectarcrm_Record_Model::getInstanceById($sourceRecordId, $sourceModuleName);
