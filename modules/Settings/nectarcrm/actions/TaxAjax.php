...
class Settings_nectarcrm_TaxAjax_Action extends Settings_nectarcrm_Basic_Action {
	...
	public function saveTax(nectarcrm_Request $request) {
	...
	public function updateTaxStatus(nectarcrm_Request $request) {
		$taxId = $request->get('taxid');
		$type = $request->get('type');
	...
	public function saveTaxRegion(nectarcrm_Request $request) {
	...
	public function deleteTaxRegion(nectarcrm_Request $request) {
		$taxRegionId = $request->get('taxRegionId');
		$response = new nectarcrm_Response();
		if ($taxRegionId) {
			try {
	...
	public function saveCharge(nectarcrm_Request $request) {
	...
	public function deleteCharge(nectarcrm_Request $request) {
		$chargeId = $request->get('chargeId');
		$response = new nectarcrm_Response();
		if ($chargeId) {
			try {
	...
	public function checkDuplicateTaxName(nectarcrm_Request $request) {
	...
	public function checkDuplicateInventoryCharge(nectarcrm_Request $request) {
	...
	public function checkDuplicateTaxRegion(nectarcrm_Request $request) {
