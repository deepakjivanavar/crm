 ...
 */
class Settings_nectarcrm_Module_Model extends nectarcrm_Base_Model {

	var $baseTable = 'nectarcrm_settings_field';
	...
	public function getField($fieldName) {
		return new nectarcrm_Base_Model(array('name' => $fieldName, 'label' => $fieldName));
	}
	 ...
	 * @return <Array> - List of Settings_nectarcrm_Menu_Model instances
	 */
	public function getMenus() {
		return Settings_nectarcrm_Menu_Model::getAll();
	}
	...
	public function getMenuItems($menu=false) {
		$menuModel = false;
		if($menu) {
			$menuModel = Settings_nectarcrm_Menu_Model::getInstance($menu);
		}
		return Settings_nectarcrm_MenuItem_Model::getAll($menuModel);
	}
	...
	/** 
	 * Fucntion to get the settings menu item for nectarcrm7
	...
	static function getActiveBlockName($request) {
		...
		$query = "SELECT nectarcrm_settings_blocks.label AS blockname, nectarcrm_settings_field.name AS menu FROM nectarcrm_settings_blocks
					INNER JOIN nectarcrm_settings_field ON nectarcrm_settings_field.blockid=nectarcrm_settings_blocks.blockid
