...
class Settings_nectarcrm_Systems_Model extends nectarcrm_Base_Model{

    const tableName = 'nectarcrm_systems';
    ...
    public static function getInstanceFromServerType($type,$componentName) {
        ...
        try{
        $modelClassName = nectarcrm_Loader::getComponentClassName('Model', $componentName, 'Settings:nectarcrm');
        }catch(Exception $e) {
            $modelClassName = self;
        }
