...
class Settings_nectarcrm_ConfigModule_Model extends Settings_nectarcrm_Module_Model {
	...
	public function getMenuItem() {
		$menuItem = Settings_nectarcrm_MenuItem_Model::getInstance('Configuration Editor');
		return $menuItem;
	}
	...
	public function getEditViewUrl() {
		...
		return '?module=nectarcrm&parent=Settings&view=ConfigEditorEdit&block='.$menuItem->get('blockid').'&fieldid='.$menuItem->get('fieldid');
	}
	...
	public function getDetailViewUrl() {
		$menuItem = $this->getMenuItem();
		return '?module=nectarcrm&parent=Settings&view=ConfigEditorDetail&block='.$menuItem->get('blockid').'&fieldid='.$menuItem->get('fieldid');
	}
	...
	public function getPicklistValues($fieldName) {
		if ($fieldName === 'default_module') {
			...
			$query = 'SELECT name, tablabel FROM nectarcrm_tab WHERE presence IN (' . generateQuestionMarks($presence) . ') AND isentitytype = ? AND name NOT IN (' . generateQuestionMarks($restrictedModules) . ')';
	 ...
	 * @return <Settings_nectarcrm_ConfigModule_Model> $moduleModel
	 */
