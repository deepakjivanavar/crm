...
class Settings_Picklist_Index_View extends Settings_nectarcrm_Index_View {
    ...
    public function process(nectarcrm_Request $request) {
        ...
        if(count($pickListFields) > 0) {
            ...
            $selectedFieldAllPickListValues = nectarcrm_Util_Helper::getPickListValues($selectedPickListFieldModel->getName());
