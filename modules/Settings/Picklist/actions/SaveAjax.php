...
class Settings_Picklist_SaveAjax_Action extends Settings_nectarcrm_Basic_Action {
    ...
    public function updateDefaultPicklistValues($pickListFieldName,$oldValue,$newValue) {
		$db = PearDatabase::getInstance();
            ...
            $queryToGetId = 'SELECT id FROM nectarcrm_users WHERE '.$defaultFieldName.' IN (';
            ...
            for($i=0; $i<$rowCount; $i++) {
                ...
                $record = nectarcrm_Record_Model::getInstanceById($recordId, 'Users');
    ...
    public function add(nectarcrm_Request $request) {
    ...
    public function rename(nectarcrm_Request $request) {
        $moduleName = $request->get('source_module');
     ...
     */
    public function assignValueToRole(nectarcrm_Request $request) {
        $pickListFieldName = $request->get('picklistName');
    ...
    public function saveOrder(nectarcrm_Request $request) {
        $pickListFieldName = $request->get('picklistName');
    ...
    public function enableOrDisable(nectarcrm_Request $request) {
        $pickListFieldName = $request->get('picklistName');
    ...
    public function edit(nectarcrm_Request $request) {
        $moduleName = $request->get('source_module');
