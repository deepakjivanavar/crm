<?php
/**
 * Copyright (c) 2004-2014 All Right Reserved, www.nectarcrm.com
 * nectarcrm Proprietary License
 * The contents of this file cannot be modified or redistributed 
 * without explicit permission from nectarcrm (www.nectarcrm.com).
 */

Class Settings_ModuleManager_LoaderSuggest {

	function nectarcrm_extensionloader_suggest() {
		$PHPVER = sprintf("%s.%s", PHP_MAJOR_VERSION, PHP_MINOR_VERSION);
		$OSHWINFO = str_replace('Darwin', 'Mac', PHP_OS).'_'.php_uname('m');

		$WIN = (strtoupper(substr(PHP_OS, 0, 3)) === 'WIN') ? true : false;

		$EXTFNAME = 'nectarcrmextn_loader';
