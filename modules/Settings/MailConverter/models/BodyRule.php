...
class Settings_MailConverter_BodyRule_Model extends Settings_MailConverter_RuleRecord_Model {
	...
	var $_bodyruleTable = 'nectarcrm_mailscanner_bodyrule';
	var $_bodyruleMappingTable = 'nectarcrm_mailscanner_mapping';

  public static function getCleanInstance($qualifiedModuleName='Settings:MailConverter'){
		$modelClassName = nectarcrm_Loader::getComponentClassName('Model', 'BodyRule', $qualifiedModuleName);
