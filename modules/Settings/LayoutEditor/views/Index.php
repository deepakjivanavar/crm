...
class Settings_LayoutEditor_Index_View extends Settings_nectarcrm_Index_View {
	...
	public function showFieldLayout(nectarcrm_Request $request) {
		$sourceModule = $request->get('sourceModule');
		$supportedModulesList = Settings_LayoutEditor_Module_Model::getSupportedModules();
		$supportedModulesList = array_flip($supportedModulesList);
		ksort($supportedModulesList);
	...
	public function showRelatedListLayout(nectarcrm_Request $request) {
		$sourceModule = $request->get('sourceModule');
		$supportedModulesList = Settings_LayoutEditor_Module_Model::getSupportedModules();
	...
	public function showFieldEdit(nectarcrm_Request $request) {
		$sourceModule = $request->get('sourceModule');
	...
	public function showDuplicationHandling(nectarcrm_Request $request) {
		$qualifiedModule = $request->getModule(false);
		...
		$viewer->assign('ACTIONS', nectarcrm_Module_Model::getSyncActionsInDuplicatesCheck());
		$viewer->assign('USER_MODEL', Users_Record_Model::getCurrentUserModel());
