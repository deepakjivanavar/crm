...
class Settings_LayoutEditor_Field_Action extends Settings_nectarcrm_Index_Action {
    ...
    public function move(nectarcrm_Request $request) {
    ...
    public function unHide(nectarcrm_Request $request) {
        $response = new nectarcrm_Response();
        try{
	...
	public function updateDuplicateHandling(nectarcrm_Request $request) {
		$response = new nectarcrm_Response();
		try {
