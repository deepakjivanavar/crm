...
class Settings_SMSNotifier_Module_Model extends Settings_nectarcrm_Module_Model {

	var $baseTable = 'nectarcrm_smsnotifier_servers';
	...
	public static function deleteRecords($recordIdsList = array()) {
		if ($recordIdsList) {
			...
			$query = 'DELETE FROM nectarcrm_smsnotifier_servers WHERE id IN (' . generateQuestionMarks($recordIdsList). ')';
