...
vimport('~~/modules/WSAPP/Handlers/nectarcrmCRMHandler.php');
vimport('~~/include/Webservices/Utils.php');
class Google_nectarcrm_Handler extends nectarcrmCRMHandler {
	...
	public function put($recordDetails, $user) {
		...
		foreach ($updatedRecords as $index => $record) {
			$webserviceRecordId = $record["id"];
			//While Updating nectarcrm Record, should not update these values for event
