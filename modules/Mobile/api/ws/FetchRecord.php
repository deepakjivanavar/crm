...
class Mobile_WS_FetchRecord extends Mobile_WS_Controller {
	...
	function getRelatedRecordCount(Mobile_API_Request $request) {
		...
		$parentModuleModel = nectarcrm_Module_Model::getInstance($module);
        $parentRecordModel = nectarcrm_Record_Model::getInstanceById($record, $parentModuleModel);
		...
		foreach($relationModels as $relation) {
			...
			$relationListView = nectarcrm_RelationListView_Model::getInstance($parentRecordModel, $relatedModuleName, $relation->get('label'),$relationId);
