 ...
 * All Rights Reserved.
 *************************************************************************************/
require_once 'modules/WSAPP/Handlers/nectarcrmCRMHandler.php';
require_once 'include/utils/GetUserGroups.php';


class OutlooknectarcrmCRMHandler extends nectarcrmCRMHandler{
                    ...
                    if(!empty($entityNameIds[$refFieldValue])){
                        ...
                        if($referenceFieldName == 'account_id'){
                            if($recordInfo[$referenceFieldName]!=NULL){
                                ...
                                $element['source'] = nectarcrm_Cache::get('WSAPP','appName');
    ...
    public function translateTheReferenceFieldIdsToName($records, $module, $user) {
     ...
     /*
     * Function to attach outlook attendees to Contacts of nectarcrm Event
     */
