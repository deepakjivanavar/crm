 ...
 */
class Reports_ListView_Model extends nectarcrm_ListView_Model {
	...
	public function getListViewLinks() {
		...
		$links = nectarcrm_Link_Model::getAllByType($moduleModel->getId(), array('LISTVIEWBASIC'));
		return $links;
	}
	...
	public function getListViewHeadersFornectarcrm7($folderId){
		$headers = array(
