<?php /* Smarty version Smarty-3.1.7, created on 2019-12-06 09:45:07
         compiled from "/var/www/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/QuickViewCommentsList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2500927575dea232303d858-77545269%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd26d9c33d2a1b9aea920cd4d81f5fd87fe6c6024' => 
    array (
      0 => '/var/www/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/QuickViewCommentsList.tpl',
      1 => 1574851712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2500927575dea232303d858-77545269',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dea232307f5e',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dea232307f5e')) {function content_5dea232307f5e($_smarty_tpl) {?>
                                        ...
                                        <div class="comment col-lg-10">
                                            ...
                                            <div class="commentActionsContainer">      
                                                <span class="commentTime pull-right">
                                                    <p class="muted"><small title="<?php echo nectarcrm_Util_Helper::formatDateTimeIntoDayString($_smarty_tpl->tpl_vars['COMMENT']->value->getCommentedTime());?>
"><?php echo nectarcrm_Util_Helper::formatDateAndDateDiffInString($_smarty_tpl->tpl_vars['COMMENT']->value->getCommentedTime());?>
</small></p>
                                                </span>
                                            </div>
...
?>
                                                    ...
                                                    <?php if (!empty($_smarty_tpl->tpl_vars['FILE_NAME']->value)){?>
                                                        <a onclick="nectarcrm_List_Js.previewFile(event,<?php echo $_smarty_tpl->tpl_vars['COMMENT']->value->get('id');?>
