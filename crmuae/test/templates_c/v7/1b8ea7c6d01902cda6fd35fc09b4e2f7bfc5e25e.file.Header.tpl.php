<?php /* Smarty version Smarty-3.1.7, created on 2019-12-04 11:23:11
         compiled from "/var/www/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/Header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9443752105de7971fc71688-06158877%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1b8ea7c6d01902cda6fd35fc09b4e2f7bfc5e25e' => 
    array (
      0 => '/var/www/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/Header.tpl',
      1 => 1574851710,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9443752105de7971fc71688-06158877',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5de7971fcf151',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5de7971fcf151')) {function content_5de7971fcf151($_smarty_tpl) {?>
...
><?php $_smarty_tpl->tpl_vars['V7_THEME_PATH'] = new Smarty_variable(nectarcrm_Theme::getv7AppStylePath($_smarty_tpl->tpl_vars['SELECTED_MENU_CATEGORY']->value), null, 0);?><?php if (strpos($_smarty_tpl->tpl_vars['V7_THEME_PATH']->value,".less")!==false){?><link type="text/css" rel="stylesheet/less" href="<?php echo vresource_url($_smarty_tpl->tpl_vars['V7_THEME_PATH']->value);?>
...
"};<?php }?></script></head><?php $_smarty_tpl->tpl_vars['CURRENT_USER_MODEL'] = new Smarty_variable(Users_Record_Model::getCurrentUserModel(), null, 0);?><body data-skinpath="<?php echo nectarcrm_Theme::getBaseThemePath();?>
