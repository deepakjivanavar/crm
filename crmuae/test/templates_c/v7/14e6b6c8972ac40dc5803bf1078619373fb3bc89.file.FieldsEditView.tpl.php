<?php /* Smarty version Smarty-3.1.7, created on 2019-10-21 10:26:34
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/v7\modules\Settings\Webforms\FieldsEditView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6107201005dad87dab36595-86545801%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '14e6b6c8972ac40dc5803bf1078619373fb3bc89' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/v7\\modules\\Settings\\Webforms\\FieldsEditView.tpl',
      1 => 1571120077,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6107201005dad87dab36595-86545801',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dad87dab948a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dad87dab948a')) {function content_5dad87dab948a($_smarty_tpl) {?>
...
?><?php $_smarty_tpl->tpl_vars["FIELD_INFO"] = new Smarty_variable(nectarcrm_Functions::jsonEncode($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldInfo()), null, 0);?><option value="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name');?>
...
<?php }?><?php if (!$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatory(true)){?><div class="pull-right actions"><span class="actionImages"><a class="removeTargetModuleField" href="javascript:void(0);"><i class="icon-remove-sign"></i></a></span></div><?php }?></td></tr><?php }?><?php } ?><?php } ?></tbody></table></div><?php if (nectarcrm_Functions::isDocumentsRelated($_smarty_tpl->tpl_vars['SOURCE_MODULE']->value)){?><div class="fieldBlockContainer"><div class="fieldBlockHeader"><h4><?php echo vtranslate('LBL_UPLOAD_DOCUMENTS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
