<?php /* Smarty version Smarty-3.1.7, created on 2019-12-11 07:31:04
         compiled from "/var/www/crmuat/includes/runtime/../../layouts/v7/modules/Settings/LayoutEditor/DefaultValueUi.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2825667035de7a5fa9f8bf6-98734620%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '74092cf09a4455b33f0f5b975b12efee6aad7a3a' => 
    array (
      0 => '/var/www/crmuat/includes/runtime/../../layouts/v7/modules/Settings/LayoutEditor/DefaultValueUi.tpl',
      1 => 1576049173,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2825667035de7a5fa9f8bf6-98734620',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5de7a5faa427b',
  'variables' => 
  array (
    'FIELD_MODEL' => 0,
    'QUALIFIED_MODULE' => 0,
...
<?php if ($_valid && !is_callable('content_5de7a5faa427b')) {function content_5de7a5faa427b($_smarty_tpl) {?>

<?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isDefaultValueOptionDisabled()!="true"){?><div class="form-group"><label class="control-label fieldLabel col-sm-5" style="width:32.666667%!important"><img src="<?php echo vimage_path('DefaultValue.png');?>
...
?><option value="<?php echo nectarcrm_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKLIST_NAME']->value);?>
...
foreach ($_from as $_smarty_tpl->tpl_vars['PICKLIST_VALUE']->key => $_smarty_tpl->tpl_vars['PICKLIST_VALUE']->value){
$_smarty_tpl->tpl_vars['PICKLIST_VALUE']->_loop = true;
?><option value="<?php echo nectarcrm_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKLIST_VALUE']->value);?>
" <?php if (in_array(nectarcrm_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKLIST_VALUE']->value),$_smarty_tpl->tpl_vars['FIELD_VALUE_LIST']->value)){?> selected <?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['PICKLIST_VALUE']->value,$_smarty_tpl->tpl_vars['SELECTED_MODULE_NAME']->value);?>
