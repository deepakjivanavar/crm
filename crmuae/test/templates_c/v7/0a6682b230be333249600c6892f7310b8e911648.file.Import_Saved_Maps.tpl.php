<?php /* Smarty version Smarty-3.1.7, created on 2019-12-06 10:26:12
         compiled from "/var/www/crmuat/includes/runtime/../../layouts/v7/modules/Import/Import_Saved_Maps.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19372801695dea2cc4979113-27152768%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0a6682b230be333249600c6892f7310b8e911648' => 
    array (
      0 => '/var/www/crmuat/includes/runtime/../../layouts/v7/modules/Import/Import_Saved_Maps.tpl',
      1 => 1574851704,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19372801695dea2cc4979113-27152768',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dea2cc4990a9',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dea2cc4990a9')) {function content_5dea2cc4990a9($_smarty_tpl) {?>
...
<div class="row" style = "margin-bottom: 10px">
    <div class = "form-group">
        ...
        <div class="col-lg-4">
            <select name="saved_maps" id="saved_maps" class="select2 form-control" onchange="nectarcrm_Import_Js.loadSavedMap();">
...
"><?php echo $_smarty_tpl->tpl_vars['_MAP']->value->getValue('name');?>
        ...
        <div id="delete_map_container" class ="col-lg-1" style="display:none; margin-top: 10px">
            <a class="glyphicon glyphicon-trash cursorPointer" onclick="nectarcrm_Import_Js.deleteMap('<?php echo $_smarty_tpl->tpl_vars['FOR_MODULE']->value;?>
