<?php /* Smarty version Smarty-3.1.7, created on 2019-10-18 10:36:30
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/v7\modules\Settings\LayoutEditor\FieldsList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1522678285da995aeceb940-38898146%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '603bf9c17895d70b95655cca2190b2dbfeec08ef' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/v7\\modules\\Settings\\LayoutEditor\\FieldsList.tpl',
      1 => 1520586670,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1522678285da995aeceb940-38898146',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5da995aee1184',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5da995aee1184')) {function content_5da995aee1184($_smarty_tpl) {?>
...
</button></span></li><?php }?><?php }?></ul></div></div><?php } ?></div></div></div><input type="hidden" class="inActiveFieldsArray" value='<?php echo nectarcrm_Functions::jsonEncode($_smarty_tpl->tpl_vars['IN_ACTIVE_FIELDS']->value);?>
' /><input type="hidden" id="headerFieldsCount" value="<?php echo $_smarty_tpl->tpl_vars['HEADER_FIELDS_COUNT']->value;?>
"><input type="hidden" id="nameFields" value='<?php echo nectarcrm_Functions::jsonEncode($_smarty_tpl->tpl_vars['SELECTED_MODULE_MODEL']->value->getNameFields());?>
'><input type="hidden" id="headerFieldsMeta" value='<?php echo nectarcrm_Functions::jsonEncode($_smarty_tpl->tpl_vars['HEADER_FIELDS_META']->value);?>
