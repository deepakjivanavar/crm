<?php /* Smarty version Smarty-3.1.7, created on 2019-10-21 05:25:27
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/v7\modules\Google\ExtensionSettings.tpl" */ ?>
<?php /*%%SmartyHeaderCode:346449595dad4147350699-77866571%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6c4ab8405fb213696b97dcfd6690c0d67e9cb365' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/v7\\modules\\Google\\ExtensionSettings.tpl',
      1 => 1571119996,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '346449595dad4147350699-77866571',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dad41473b031',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dad41473b031')) {function content_5dad41473b031($_smarty_tpl) {?>
...
" <?php if ($_smarty_tpl->tpl_vars['ENTRY']->value['id']==$_smarty_tpl->tpl_vars['SELECTED_CONTACTS_GROUP']->value){?> <?php $_smarty_tpl->tpl_vars['IS_GROUP_DELETED'] = new Smarty_variable(0, null, 0);?> selected <?php }?>><?php echo $_smarty_tpl->tpl_vars['ENTRY']->value['title'];?>
							...
							<td>
								<select name="Contacts[sync_direction]" class="inputElement select2 row" style="min-width: 250px;">
									...
									<option value="10" <?php if ($_smarty_tpl->tpl_vars['CONTACTS_SYNC_DIRECTION']->value==10){?> selected <?php }?>> <?php echo vtranslate('LBL_SYNC_FROM_GOOGLE_TO_NECTARCRM',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 </option>
									<option value="01" <?php if ($_smarty_tpl->tpl_vars['CONTACTS_SYNC_DIRECTION']->value==01){?> selected <?php }?>> <?php echo vtranslate('LBL_SYNC_FROM_NECTARCRM_TO_GOOGLE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 </option>
								</select>
							</td>
						</tr>
...
<?php }?>" <?php if ($_smarty_tpl->tpl_vars['SELECTED_GOOGLE_CALENDAR']->value==$_smarty_tpl->tpl_vars['CALENDAR_ITEM']->value['id']){?>selected<?php }?> <?php if ($_smarty_tpl->tpl_vars['SELECTED_GOOGLE_CALENDAR']->value=='primary'&&$_smarty_tpl->tpl_vars['CALENDAR_ITEM']->value['primary']==1){?> selected <?php }?>><?php echo $_smarty_tpl->tpl_vars['CALENDAR_ITEM']->value['summary'];?>
							...
							<td>
								<select name="Calendar[sync_direction]" class="inputElement select2 row" style="min-width: 250px;">
									...
									<option value="10" <?php if ($_smarty_tpl->tpl_vars['CALENDAR_SYNC_DIRECTION']->value==10){?> selected <?php }?>> <?php echo vtranslate('LBL_SYNC_FROM_GOOGLE_TO_NECTARCRM',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 </option>
									<option value="01" <?php if ($_smarty_tpl->tpl_vars['CALENDAR_SYNC_DIRECTION']->value==01){?> selected <?php }?>> <?php echo vtranslate('LBL_SYNC_FROM_NECTARCRM_TO_GOOGLE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 </option>
								</select>
							</td>
						</tr>
