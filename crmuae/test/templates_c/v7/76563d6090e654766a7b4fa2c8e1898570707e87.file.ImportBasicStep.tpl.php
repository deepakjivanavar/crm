<?php /* Smarty version Smarty-3.1.7, created on 2019-11-07 04:37:29
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/v7\modules\Import\ImportBasicStep.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13556431805dc39f890a19d1-94743325%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '76563d6090e654766a7b4fa2c8e1898570707e87' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/v7\\modules\\Import\\ImportBasicStep.tpl',
      1 => 1571119902,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13556431805dc39f890a19d1-94743325',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dc39f890e8da',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dc39f890e8da')) {function content_5dc39f890e8da($_smarty_tpl) {?>
...
</a><?php }else{ ?><div id="importStepOneButtonsDiv"><?php if ($_smarty_tpl->tpl_vars['DUPLICATE_HANDLING_NOT_SUPPORTED']->value=='true'){?><button class="btn btn-success btn-lg" id="skipDuplicateMerge" onclick="nectarcrm_Import_Js.uploadAndParse('0');"><?php echo vtranslate('LBL_NEXT_BUTTON_LABEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button><?php }else{ ?><button class="btn btn-success btn-lg" id ="importStep2" onclick="nectarcrm_Import_Js.importActionStep2();"><?php echo vtranslate('LBL_NEXT_BUTTON_LABEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button><?php }?>&nbsp;&nbsp;&nbsp;<a class='cancelLink' onclick="nectarcrm_Import_Js.loadListRecords();" data-dismiss="modal" href="#"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</a></div><div id="importStepTwoButtonsDiv" class = "hide"><button class="btn btn-default btn-lg" id="backToStep1" onclick="nectarcrm_Import_Js.bactToStep1();"><?php echo vtranslate('LBL_BACK',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button>&nbsp;&nbsp;&nbsp;<button name="next" class="btn btn-success btn-lg" id="uploadAndParse" onclick="nectarcrm_Import_Js.uploadAndParse('1');"><?php echo vtranslate('LBL_NEXT_BUTTON_LABEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button>&nbsp;&nbsp;&nbsp;<button class="btn btn-primary btn-lg" id="skipDuplicateMerge" onclick="nectarcrm_Import_Js.uploadAndParse('0');"><?php echo vtranslate('Skip this step',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button>&nbsp;&nbsp;&nbsp;<a class='cancelLink' data-dismiss="modal" href="#"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
