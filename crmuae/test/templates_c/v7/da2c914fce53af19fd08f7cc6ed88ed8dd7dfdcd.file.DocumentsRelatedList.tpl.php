<?php /* Smarty version Smarty-3.1.7, created on 2019-11-18 10:34:28
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/v7\modules\Documents\DocumentsRelatedList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2000168315dd273b4270253-23439138%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'da2c914fce53af19fd08f7cc6ed88ed8dd7dfdcd' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/v7\\modules\\Documents\\DocumentsRelatedList.tpl',
      1 => 1520586670,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2000168315dd273b4270253-23439138',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dd273b438a90',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dd273b438a90')) {function content_5dd273b438a90($_smarty_tpl) {?>
...
</button></div><?php }?><?php if ($_smarty_tpl->tpl_vars['RELATED_LINK']->value->getLabel()=='nectarcrm'){?><?php if ($_smarty_tpl->tpl_vars['IS_CREATE_PERMITTED']->value){?><div class="col-sm-3"><div class="dropdown"><button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"><span class="fa fa-plus" title="<?php echo vtranslate('LBL_NEW_DOCUMENT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</li><li id="nectarcrmAction"><a href="javascript:Documents_Index_Js.uploadTo('nectarcrm',<?php echo $_smarty_tpl->tpl_vars['PARENT_ID']->value;?>
,'<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
')"><img style="  margin-top: -3px;margin-right: 4%;" title="nectarcrm" alt="nectarcrm" src="layouts/v7/skins//images/nectarcrm.png"><?php ob_start();?><?php echo vtranslate('LBL_NECTARCRM',$_smarty_tpl->tpl_vars['RELATED_MODULE_NAME']->value);?>
...
" class="vicon-linkopen"></i></a>&nbsp;&nbsp;<?php }?><?php $_smarty_tpl->tpl_vars['RECORD_ID'] = new Smarty_variable($_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getId(), null, 0);?><?php $_smarty_tpl->tpl_vars["DOCUMENT_RECORD_MODEL"] = new Smarty_variable(nectarcrm_Record_Model::getInstanceById($_smarty_tpl->tpl_vars['RECORD_ID']->value), null, 0);?><?php if ($_smarty_tpl->tpl_vars['DOCUMENT_RECORD_MODEL']->value->get('filename')&&$_smarty_tpl->tpl_vars['DOCUMENT_RECORD_MODEL']->value->get('filestatus')){?><a name="viewfile" href="javascript:void(0)" data-filelocationtype="<?php echo $_smarty_tpl->tpl_vars['DOCUMENT_RECORD_MODEL']->value->get('filelocationtype');?>
" data-filename="<?php echo $_smarty_tpl->tpl_vars['DOCUMENT_RECORD_MODEL']->value->get('filename');?>
" onclick="nectarcrm_Header_Js.previewFile(event)"><i title="<?php echo vtranslate('LBL_VIEW_FILE',$_smarty_tpl->tpl_vars['RELATED_MODULE_NAME']->value);?>
...
foreach ($_from as $_smarty_tpl->tpl_vars['HEADER_FIELD']->key => $_smarty_tpl->tpl_vars['HEADER_FIELD']->value){
$_smarty_tpl->tpl_vars['HEADER_FIELD']->_loop = true;
?><?php $_smarty_tpl->tpl_vars['RELATED_HEADERNAME'] = new Smarty_variable($_smarty_tpl->tpl_vars['HEADER_FIELD']->value->get('name'), null, 0);?><?php $_smarty_tpl->tpl_vars['RELATED_LIST_VALUE'] = new Smarty_variable($_smarty_tpl->tpl_vars['RELATED_RECORD']->value->get($_smarty_tpl->tpl_vars['RELATED_HEADERNAME']->value), null, 0);?><?php $_smarty_tpl->tpl_vars['IS_DOCUMENT_SOURCE_FIELD'] = new Smarty_variable(0, null, 0);?><?php if ($_smarty_tpl->tpl_vars['RELATED_MODULE']->value->get('name')=='Documents'&&$_smarty_tpl->tpl_vars['RELATED_HEADERNAME']->value=='document_source'){?><?php if ($_smarty_tpl->tpl_vars['RELATED_RECORD']->value->get($_smarty_tpl->tpl_vars['RELATED_HEADERNAME']->value)=='nectarcrm'||$_smarty_tpl->tpl_vars['RELATED_RECORD']->value->get($_smarty_tpl->tpl_vars['RELATED_HEADERNAME']->value)=='Google Drive'||$_smarty_tpl->tpl_vars['RELATED_RECORD']->value->get($_smarty_tpl->tpl_vars['RELATED_HEADERNAME']->value)=='Dropbox'){?><?php $_smarty_tpl->tpl_vars['IS_DOCUMENT_SOURCE_FIELD'] = new Smarty_variable(1, null, 0);?><?php }?><?php }?><td class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
...
-<?php echo nectarcrm_Util_Helper::convertSpaceToHyphen($_smarty_tpl->tpl_vars['RELATED_LIST_VALUE']->value);?>
