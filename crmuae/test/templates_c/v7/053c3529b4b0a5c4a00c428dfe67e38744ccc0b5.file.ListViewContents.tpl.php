<?php /* Smarty version Smarty-3.1.7, created on 2019-10-18 03:46:06
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/v7\modules\Reports\ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21372567765da9357e1d3c93-01494848%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '053c3529b4b0a5c4a00c428dfe67e38744ccc0b5' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/v7\\modules\\Reports\\ListViewContents.tpl',
      1 => 1520586670,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21372567765da9357e1d3c93-01494848',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5da9357e2a221',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5da9357e2a221')) {function content_5da9357e2a221($_smarty_tpl) {?>

<div class="col-sm-12 col-xs-12 "><?php $_smarty_tpl->tpl_vars['LEFTPANELHIDE'] = new Smarty_variable($_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->get('leftpanelhide'), null, 0);?><div class="essentials-toggle" title="<?php echo vtranslate('LBL_LEFT_PANEL_SHOW_HIDE','nectarcrm');?>
...
" id="noOfEntries"><input type="hidden" name="currentSearchParams" value="<?php echo nectarcrm_Util_Helper::toSafeHTML(Zend_JSON::encode($_smarty_tpl->tpl_vars['SEARCH_DETAILS']->value));?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["LISTVIEW_HEADERS"] = new Smarty_variable($_smarty_tpl->tpl_vars['LISTVIEW_MODEL']->value->getListViewHeadersFornectarcrm7($_tmp1), null, 0);?><?php  $_smarty_tpl->tpl_vars['LISTVIEW_HEADER'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->_loop = false;
...
"><span class='fa fa-pie-chart fa-2x' style="font-size:1.7em;"></span></center><?php }?><?php }elseif($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value=='primarymodule'){?><?php echo nectarcrm_Util_Helper::tosafeHTML(decode_html(vtranslate($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value,$_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value)));?>
<?php }elseif($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value=='foldername'){?><?php echo nectarcrm_Util_Helper::tosafeHTML(vtranslate($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value,$_smarty_tpl->tpl_vars['MODULE']->value));?>
<?php }else{ ?><?php echo nectarcrm_Util_Helper::tosafeHTML($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value);?>
...
"> <?php echo vtranslate('LBL_CREATE');?>
 ...
 <a style="color:blue" href="#" onclick="return nectarcrm_Import_Js.triggerImportAction()"> <?php echo vtranslate('LBL_IMPORT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
