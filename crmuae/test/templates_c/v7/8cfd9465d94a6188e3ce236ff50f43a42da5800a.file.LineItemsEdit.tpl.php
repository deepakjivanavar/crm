<?php /* Smarty version Smarty-3.1.7, created on 2019-10-21 11:47:25
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/v7\modules\Inventory\partials\LineItemsEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6156602785dad9acdeb2148-50291403%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8cfd9465d94a6188e3ce236ff50f43a42da5800a' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/v7\\modules\\Inventory\\partials\\LineItemsEdit.tpl',
      1 => 1520586670,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6156602785dad9acdeb2148-50291403',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dad9ace07e7a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dad9ace07e7a')) {function content_5dad9ace07e7a($_smarty_tpl) {?>
...
</label>&nbsp;<select class="select2" id="region_id" name="region_id" style="width: 164px;"><option value="0" data-info="<?php echo nectarcrm_Util_Helper::toSafeHTML(Zend_Json::encode($_smarty_tpl->tpl_vars['DEFAULT_TAX_REGION_INFO']->value));?>
...
" data-info='<?php echo nectarcrm_Util_Helper::toSafeHTML(Zend_Json::encode($_smarty_tpl->tpl_vars['TAX_REGION_INFO']->value));?>
...
</td><td class="lineOnTop"><input type="text" size="5" data-compound-on="<?php if ($_smarty_tpl->tpl_vars['tax_detail']->value['method']=='Compound'){?><?php echo nectarcrm_Util_Helper::toSafeHTML(Zend_Json::encode($_smarty_tpl->tpl_vars['tax_detail']->value['compoundon']));?>
