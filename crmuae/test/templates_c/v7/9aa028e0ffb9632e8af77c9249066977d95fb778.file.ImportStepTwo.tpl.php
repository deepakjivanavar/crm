<?php /* Smarty version Smarty-3.1.7, created on 2019-11-07 04:37:29
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/v7\modules\Import\ImportStepTwo.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4770578125dc39f8930b4e7-57727254%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9aa028e0ffb9632e8af77c9249066977d95fb778' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/v7\\modules\\Import\\ImportStepTwo.tpl',
      1 => 1571119902,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4770578125dc39f8930b4e7-57727254',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dc39f893237d',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dc39f893237d')) {function content_5dc39f893237d($_smarty_tpl) {?>
...
"><?php echo vtranslate($_smarty_tpl->tpl_vars['_FIELD_INFO']->value->getFieldLabelKey(),$_smarty_tpl->tpl_vars['FOR_MODULE']->value);?>
                        ...
                        <td width="6%">
                            <div align="center">
                                <button class="btn btn-default btn-lg" onClick ="return nectarcrm_Import_Js.copySelectedOptions('#available_fields', '#selected_merge_fields')"><span class="glyphicon glyphicon-arrow-right"></span></button>
                                <button class="btn btn-default btn-lg" onClick ="return nectarcrm_Import_Js.removeSelectedOptions('#selected_merge_fields')"><span class="glyphicon glyphicon-arrow-left"></span></button>
                            </div>
                        </td>
                        <td>
