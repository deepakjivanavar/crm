<?php /* Smarty version Smarty-3.1.7, created on 2019-12-13 13:26:50
         compiled from "/var/www/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/JSResources.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17747431915de79720209ff2-66652146%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3509aa6791fc671fa96361b3baa62a8f0be9812f' => 
    array (
      0 => '/var/www/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/JSResources.tpl',
      1 => 1576243591,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17747431915de79720209ff2-66652146',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5de7972024726',
  'variables' => 
  array (
    'SCRIPTS' => 0,
    'jsModel' => 0,
...
"></script><script type="text/javascript" src="<?php echo vresource_url('layouts/v7/modules/nectarcrm/resources/Utils.js');?>
"></script><script type='text/javascript' src="<?php echo vresource_url('layouts/v7/modules/nectarcrm/resources/validation.js');?>
"></script><script type="text/javascript" src="<?php echo vresource_url('layouts/v7/lib/bootbox/bootbox.js');?>
"></script><script type="text/javascript" src="<?php echo vresource_url('layouts/v7/modules/nectarcrm/resources/Base.js');?>
"></script><script type="text/javascript" src="<?php echo vresource_url('layouts/v7/modules/nectarcrm/resources/nectarcrm.js');?>
...
"></script><script type="text/javascript" src="<?php echo vresource_url('layouts/v7/modules/nectarcrm/resources/CkEditor.js');?>
...
"></script><!-- Added in the end since it should be after less file loaded --><script type="text/javascript" src="libraries/bootstrap/js/less.min.js"></script><!-- Enable tracking pageload time --><script type="text/javascript">jQuery.validator.addMethod( "notEqualTo", function( value, element, param ) {return this.optional( element ) || !jQuery.validator.methods.equalTo.call( this, value, element, param );}, "Please enter a different value, values must not be the same." );var _REQSTARTTIME = "<?php echo $_SERVER['REQUEST_TIME'];?>
