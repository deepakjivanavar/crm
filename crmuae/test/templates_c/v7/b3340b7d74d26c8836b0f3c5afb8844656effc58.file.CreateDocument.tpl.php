<?php /* Smarty version Smarty-3.1.7, created on 2019-11-22 05:48:22
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/v7\modules\Documents\CreateDocument.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18585764605dd776a603e2b8-96100329%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b3340b7d74d26c8836b0f3c5afb8844656effc58' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/v7\\modules\\Documents\\CreateDocument.tpl',
      1 => 1520586670,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18585764605dd776a603e2b8-96100329',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dd776a60a7fc',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dd776a60a7fc')) {function content_5dd776a60a7fc($_smarty_tpl) {?>
...
<div class="modal-body"><div class="uploadview-content container-fluid"><div id="create"><form class="form-horizontal recordEditView" name="upload" method="post" action="index.php"><?php if (!empty($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value)){?><input type="hidden" name="picklistDependency" value='<?php echo nectarcrm_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value);?>
' /><?php }?><input type="hidden" name="module" value="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
" /><input type="hidden" name="action" value="SaveAjax" /><input type="hidden" name="document_source" value="nectarcrm" /><input type="hidden" name='service' value="<?php echo $_smarty_tpl->tpl_vars['STORAGE_SERVICE']->value;?>
