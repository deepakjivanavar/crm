<?php /* Smarty version Smarty-3.1.7, created on 2019-12-05 07:23:06
         compiled from "/var/www/crmuat/includes/runtime/../../layouts/v7/modules/Documents/UploadDocument.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10088963595de8b05a32ddf4-70541618%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '102b09a12d6eeb7b367c75972ec78be5d03dd984' => 
    array (
      0 => '/var/www/crmuat/includes/runtime/../../layouts/v7/modules/Documents/UploadDocument.tpl',
      1 => 1574851702,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10088963595de8b05a32ddf4-70541618',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5de8b05a3b15a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5de8b05a3b15a')) {function content_5de8b05a3b15a($_smarty_tpl) {?>

<div class="modal-dialog modelContainer"><?php ob_start();?><?php echo vtranslate('LBL_UPLOAD_TO_NECTARCRM',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<div class="modal-body"><div class="uploadview-content container-fluid"><div class="uploadcontrols row"><div id="upload" data-filelocationtype="I"><?php if (!empty($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value)){?><input type="hidden" name="picklistDependency" value='<?php echo nectarcrm_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value);?>
' /><?php }?><input type="hidden" name="module" value="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
" /><input type="hidden" name="action" value="SaveAjax" /><input type="hidden" name="document_source" value="nectarcrm" /><?php if ($_smarty_tpl->tpl_vars['RELATION_OPERATOR']->value=='true'){?><input type="hidden" name="relationOperation" value="<?php echo $_smarty_tpl->tpl_vars['RELATION_OPERATOR']->value;?>
