<?php /* Smarty version Smarty-3.1.7, created on 2019-12-05 09:13:43
         compiled from "/var/www/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/RelatedList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7045753825de8ca47379103-21303170%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2d5ac00150db6671842b079e01798d17f64a2f09' => 
    array (
      0 => '/var/www/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/RelatedList.tpl',
      1 => 1574851712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7045753825de8ca47379103-21303170',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5de8ca474973f',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5de8ca474973f')) {function content_5de8ca474973f($_smarty_tpl) {?>
...
<?php $_tmp2=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['PICKLIST_FIELD_ID'] = new Smarty_variable($_tmp2, null, 0);?><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['HEADER_FIELD']->value->getName()=='taskstatus'){?><?php $_smarty_tpl->tpl_vars["EVENT_STATUS_FIELD_MODEL"] = new Smarty_variable(nectarcrm_Field_Model::getInstance('eventstatus',nectarcrm_Module_Model::getInstance('Events')), null, 0);?><?php if ($_smarty_tpl->tpl_vars['EVENT_STATUS_FIELD_MODEL']->value){?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['EVENT_STATUS_FIELD_MODEL']->value->getId();?>
...
<?php if ($_smarty_tpl->tpl_vars['RELATED_MODULE_NAME']->value=='Documents'&&$_smarty_tpl->tpl_vars['RELATED_HEADERNAME']->value=='filename'&&isPermitted($_smarty_tpl->tpl_vars['RELATED_MODULE_NAME']->value,'DetailView',$_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getId())=='yes'){?><span class="actionImages"><?php $_smarty_tpl->tpl_vars['RECORD_ID'] = new Smarty_variable($_smarty_tpl->tpl_vars['RELATED_RECORD']->value->getId(), null, 0);?><?php $_smarty_tpl->tpl_vars["DOCUMENT_RECORD_MODEL"] = new Smarty_variable(nectarcrm_Record_Model::getInstanceById($_smarty_tpl->tpl_vars['RECORD_ID']->value), null, 0);?><?php if ($_smarty_tpl->tpl_vars['DOCUMENT_RECORD_MODEL']->value->get('filename')&&$_smarty_tpl->tpl_vars['DOCUMENT_RECORD_MODEL']->value->get('filestatus')){?><a name="viewfile" href="javascript:void(0)" data-filelocationtype="<?php echo $_smarty_tpl->tpl_vars['DOCUMENT_RECORD_MODEL']->value->get('filelocationtype');?>
