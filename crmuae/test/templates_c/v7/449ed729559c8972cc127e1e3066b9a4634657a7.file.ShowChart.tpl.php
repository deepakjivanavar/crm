<?php /* Smarty version Smarty-3.1.7, created on 2019-11-21 11:56:06
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/v7\modules\Project\ShowChart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9794494005dd67b56df0663-77292228%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '449ed729559c8972cc127e1e3066b9a4634657a7' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/v7\\modules\\Project\\ShowChart.tpl',
      1 => 1571120085,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9794494005dd67b56df0663-77292228',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dd67b56e4b69',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dd67b56e4b69')) {function content_5dd67b56e4b69($_smarty_tpl) {?>
...
</a></span></div><br /><br /><input id="projecttasks"  type="hidden" value="<?php echo nectarcrm_Util_Helper::toSafeHTML(Zend_Json::encode($_smarty_tpl->tpl_vars['PROJECT_TASKS']->value));?>
"><input id="originalprojecttasks" type="hidden" value="<?php echo nectarcrm_Util_Helper::toSafeHTML(Zend_Json::encode($_smarty_tpl->tpl_vars['PROJECT_TASKS']->value));?>
...
</li></ul></span></div></div></div><?php }else{ ?><table class="emptyRecordsDiv"><tbody><tr><td><?php $_smarty_tpl->tpl_vars["PROJECT_TASK_MODEL"] = new Smarty_variable(nectarcrm_Module_Model::getInstance('ProjectTask'), null, 0);?><?php $_smarty_tpl->tpl_vars["IS_MODULE_EDITABLE"] = new Smarty_variable($_smarty_tpl->tpl_vars['PROJECT_TASK_MODEL']->value->isPermitted('CreateView'), null, 0);?><?php $_smarty_tpl->tpl_vars['SINGLE_MODULE'] = new Smarty_variable("SINGLE_ProjectTask", null, 0);?><?php echo vtranslate('LBL_NO');?>
