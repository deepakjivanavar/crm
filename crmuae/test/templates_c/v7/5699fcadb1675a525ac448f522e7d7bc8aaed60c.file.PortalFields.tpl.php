<?php /* Smarty version Smarty-3.1.7, created on 2019-10-21 06:55:30
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/v7\modules\Settings\CustomerPortal\PortalFields.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19794628795dad56623282d0-71061231%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5699fcadb1675a525ac448f522e7d7bc8aaed60c' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/v7\\modules\\Settings\\CustomerPortal\\PortalFields.tpl',
      1 => 1571119990,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19794628795dad56623282d0-71061231',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dad566239ab4',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dad566239ab4')) {function content_5dad566239ab4($_smarty_tpl) {?>

<input type="hidden" name="availableFields_<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
" value='<?php echo nectarcrm_Functions::jsonEncode($_smarty_tpl->tpl_vars['ALLFIELDS']->value);?>
' /><input type="hidden" name="selectedFields_<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
" value='<?php echo nectarcrm_Functions::jsonEncode($_smarty_tpl->tpl_vars['SELECTED_FIELDS']->value);?>
' /><input type="hidden" name="relatedModules_<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
" value='<?php echo nectarcrm_Functions::jsonEncode($_smarty_tpl->tpl_vars['RELATED_MODULES']->value[$_smarty_tpl->tpl_vars['MODULE']->value]);?>
' /><input type="hidden" name="recordPermissions_<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
" value='<?php echo nectarcrm_Functions::jsonEncode($_smarty_tpl->tpl_vars['RECORD_PERMISSIONS']->value);?>
