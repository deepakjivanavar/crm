<?php /* Smarty version Smarty-3.1.7, created on 2019-12-11 07:31:04
         compiled from "/var/www/crmuat/includes/runtime/../../layouts/v7/modules/Settings/LayoutEditor/FieldCreate.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14061177715de7a5fa9691f0-60184399%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3fb81777c7adfee062a0fa1ba0cc56f05b2b2cf4' => 
    array (
      0 => '/var/www/crmuat/includes/runtime/../../layouts/v7/modules/Settings/LayoutEditor/FieldCreate.tpl',
      1 => 1576049400,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14061177715de7a5fa9691f0-60184399',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5de7a5fa9f1f8',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_5de7a5fa9f1f8')) {function content_5de7a5fa9f1f8($_smarty_tpl) {?>
...
" /><div class="modal-body model-body-scrollenabled"><?php if (!$_smarty_tpl->tpl_vars['IS_FIELD_EDIT_MODE']->value){?><div class="form-group blockControlGroup hide"><label class="control-label fieldLabel col-sm-5" style="width:32.666667%!important"><?php echo vtranslate('LBL_SELECT_BLOCK',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</option><?php }?><?php } ?></select></div></div><?php }?><div class="form-group"><label class="control-label fieldLabel col-sm-5" style="width:32.666667%!important"><?php echo vtranslate('LBL_SELECT_FIELD_TYPE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</option><?php } ?></select></div></div><div class="form-group"><label class="control-label fieldLabel col-sm-5" style="width:32.666667%!important"><?php echo vtranslate('LBL_LABEL_NAME',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
" data-rule-required='true'data-rule-picklist='true'/></div></div><div class="form-group supportedType picklistOption hide"><label class="control-label fieldLabel col-sm-5" style="width:32.666667%!important">&nbsp;</label><div class="controls col-sm-7"><div class="checkbox row" style="margin-left: 5px;"><span class="col-sm-1"><input type="checkbox" name="isRoleBasedPickList" value="1" ></span><span style="margin-left: -10px;"><?php echo vtranslate('LBL_ROLE_BASED_PICKLIST',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span></div></div></div><div class="form-group supportedType relationModules hide"><label class="control-label fieldLabel col-sm-5" style="width:32.666667%!important"><?php echo vtranslate('SELECT_MODULE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
"/></label></div></div><?php }else{ ?><input type="hidden" name="presence" value="2" /><?php }?><div class="well fieldProperty"><div class="properties"><div class="row"><div class="form-group"><label class="control-label fieldLabel col-sm-5" style="width: 55.666667%!important;"><?php echo vtranslate('LBL_ENABLE_OR_DISABLE_FIELD_PROP',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</label></div></div><div class="row"><div class="form-group col-sm-7"><label class="control-label fieldLabel col-sm-10" style="width: 55.666667%!important;"><i class="fa fa-exclamation-circle"></i> &nbsp; <?php echo vtranslate('LBL_MANDATORY_FIELD',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</label><div class="controls col-sm-2"><input type="hidden" name="mandatory" value="O"/><label class="checkbox" style="margin-left: 6%;"><input type="checkbox" name="mandatory" class="<?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatoryOptionDisabled()){?> cursorPointerNotAllowed <?php }else{ ?> cursorPointer<?php }?>" value="M" <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatory()){?> checked="checked" <?php }?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatoryOptionDisabled()){?>readonly="readonly"<?php }?>/></label></div></div><div class="form-group col-sm-6"><label class="control-label fieldLabel col-sm-7" style="width: 55.666667%!important;"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo vtranslate('LBL_QUICK_CREATE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
