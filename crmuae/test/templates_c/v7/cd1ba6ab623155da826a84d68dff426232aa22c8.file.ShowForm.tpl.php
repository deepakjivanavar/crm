<?php /* Smarty version Smarty-3.1.7, created on 2019-12-05 07:11:03
         compiled from "/var/www/crmuat/includes/runtime/../../layouts/v7/modules/Settings/Webforms/ShowForm.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17476435705de8ad87500d13-20764941%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cd1ba6ab623155da826a84d68dff426232aa22c8' => 
    array (
      0 => '/var/www/crmuat/includes/runtime/../../layouts/v7/modules/Settings/Webforms/ShowForm.tpl',
      1 => 1574851730,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17476435705de8ad87500d13-20764941',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5de8ad8812fe5',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5de8ad8812fe5')) {function content_5de8ad8812fe5($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/crmuat/libraries/Smarty/libs/plugins/modifier.replace.php';
?>
...
"><textarea id="showFormContent" class="input-xxlarge" style="min-height:400px;width: 100%" readonly></textarea><code><pre><meta http-equiv="Content-Type" content="text/html;charset=UTF-8"><form id="__nectarcrmWebForm" name="<?php echo $_smarty_tpl->tpl_vars['RECORD_MODEL']->value->getName();?>
...
" <?php if (in_array(nectarcrm_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKLIST_VALUE']->value),$_smarty_tpl->tpl_vars['FIELD_VALUE_LIST']->value)){?> selected <?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['PICKLIST_VALUE']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
