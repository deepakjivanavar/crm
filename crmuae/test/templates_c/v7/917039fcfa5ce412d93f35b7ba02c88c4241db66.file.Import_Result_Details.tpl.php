<?php /* Smarty version Smarty-3.1.7, created on 2019-12-06 11:28:06
         compiled from "/var/www/crmuat/includes/runtime/../../layouts/v7/modules/Import/Import_Result_Details.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20292401885dea3b46678848-78299062%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '917039fcfa5ce412d93f35b7ba02c88c4241db66' => 
    array (
      0 => '/var/www/crmuat/includes/runtime/../../layouts/v7/modules/Import/Import_Result_Details.tpl',
      1 => 1574851704,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20292401885dea3b46678848-78299062',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dea3b466c85f',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dea3b466c85f')) {function content_5dea3b466c85f($_smarty_tpl) {?>
		...
		<td  class = "greenColor" width="60%"><?php echo $_smarty_tpl->tpl_vars['IMPORT_RESULT']->value['CREATED'];?>
			...
			<?php if ($_smarty_tpl->tpl_vars['IMPORT_RESULT']->value['CREATED']!='0'){?>
				<?php if ($_smarty_tpl->tpl_vars['FOR_MODULE']->value!='Users'){?>
					&nbsp;&nbsp;&nbsp;&nbsp;<a class="cursorPointer" onclick="return nectarcrm_Import_Js.showLastImportedRecords('index.php?module=<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
		...
		<tr>
			...
			<td width="30%"><?php echo $_smarty_tpl->tpl_vars['IMPORT_RESULT']->value['SKIPPED'];?>
				...
				<?php if ($_smarty_tpl->tpl_vars['IMPORT_RESULT']->value['SKIPPED']!='0'){?>
					&nbsp;&nbsp;&nbsp;&nbsp;<a class="cursorPointer" onclick="return nectarcrm_Import_Js.showSkippedRecords('index.php?module=<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
')"><?php echo vtranslate('LBL_DETAILS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 ...
 / <?php echo $_smarty_tpl->tpl_vars['IMPORT_RESULT']->value['TOTAL'];?>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;<a class="cursorPointer" onclick="return nectarcrm_Import_Js.showFailedImportRecords('index.php?module=<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
