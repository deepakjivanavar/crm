<?php /* Smarty version Smarty-3.1.7, created on 2019-12-16 04:51:56
         compiled from "/var/www/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/QuickCreate.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7344797875de8d76a42f8e0-78931354%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '003d43499e9a526b392d374279862b47a7bb16ed' => 
    array (
      0 => '/var/www/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/QuickCreate.tpl',
      1 => 1576238217,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7344797875de8d76a42f8e0-78931354',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5de8d76a4a251',
  'variables' => 
  array (
    'SCRIPTS' => 0,
    'jsModel' => 0,
...
<?php if ($_valid && !is_callable('content_5de8d76a4a251')) {function content_5de8d76a4a251($_smarty_tpl) {?>
...
' /><?php }?><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Events'){?><input type="hidden" name="calendarModule" value="Events"><?php if (!empty($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE_EVENT']->value)){?><input type="hidden" name="picklistDependency" value='<?php echo nectarcrm_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE_EVENT']->value);?>
