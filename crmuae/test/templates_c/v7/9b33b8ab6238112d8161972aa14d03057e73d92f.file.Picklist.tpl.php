<?php /* Smarty version Smarty-3.1.7, created on 2019-10-21 10:26:34
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/v7\modules\Settings\Webforms\uitypes\Picklist.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11035898585dad87da86ed02-63818877%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9b33b8ab6238112d8161972aa14d03057e73d92f' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/v7\\modules\\Settings\\Webforms\\uitypes\\Picklist.tpl',
      1 => 1571120077,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11035898585dad87da86ed02-63818877',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dad87da8927e',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dad87da8927e')) {function content_5dad87da8927e($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\xampp\\htdocs\\crm\\libraries\\Smarty\\libs\\plugins\\modifier.replace.php';
?>
...
'<?php }?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName()=='targetmodule'&&$_smarty_tpl->tpl_vars['MODE']->value=='edit'){?>disabled='disabled'<?php }?>><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isEmptyPicklistOptionAllowed()){?><option value=""><?php echo vtranslate('LBL_SELECT_OPTION','nectarcrm');?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['CLASS_NAME'] = new Smarty_variable("picklistColor_".($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName())."_".$_tmp1, null, 0);?><option value="<?php echo nectarcrm_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKLIST_NAME']->value);?>
