...
var app = {
	...
	getDateInnectarcrmFormat: function(dateFormat,dateObject){
	...
	registerEventForDatePickerFields : function(parentElement,registerForAddon,customParams){
		...
		element.each(function(index,domElement){
			...
			var selectedDate = app.getDateInnectarcrmFormat(dateFormat, dateObj);
	...
	registerEventForDateFields : function(parentElement) {
		...
		element.datepicker({'autoclose':true}).on('changeDate', function(ev){
			...
			var finalFormat = app.getDateInnectarcrmFormat(dateFormat,ev.date);
	...
	getPageController : function() {
		...
		if(typeof window[moduleClassName] == 'undefined'){
			moduleClassName = parentModule+"_nectarcrm_"+view+"_Js";
		}
		if(typeof window[moduleClassName] == 'undefined') {
			moduleClassName = moduleName+"_"+view+"_Js";
		}
		if(typeof window[moduleClassName] == 'undefined') {
			moduleClassName = "nectarcrm_"+view+"_Js";
		}
		if(typeof window[moduleClassName] != 'undefined') {
