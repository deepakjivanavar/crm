...
$languageStrings = array(
	...
	'LBL_CUSTOM_VIEW_NAME_DUPLICATES_EXIST' => 'filter already exists'       ,
        'LBL_EXPORT_CURRENCY_TOOLTIP_TEXT'=>'For exporting Currency values in Line items, nectarcrm will use this setting to export as this currency. Any currency values outside the line items tables, will be exported as in User\'s preferred currency (selected in \'My Preferences\')',
    ...
    'LBL_TIME' => 'Time',
    'LBL_SKIPPED' => 'Skipped',
    'vt_create' => 'nectarcrm Created',
    'vt_update' => 'nectarcrm Updated',
    'vt_delete' => 'nectarcrm Deleted',
    'vt_skip' => 'nectarcrm Skipped',
  ...
  'IMPORT_CONTACTS_GOOGLE_HELP_TEXT' => 'We can bring contacts from Google and <br> you can also enable bi-direction sync to keep our<br>
                                    nectarcrm contacts and Google contacts(in selected group updated.<br>
  ...
  'LBL_SOCIAL_LINKED' => 'Your nectarcrm is now linked to',
  'LBL_ENTER_KEYWORDS_HELP' => 'nectarcrm will scan twitter and find messages with these words',
  ...
  'LBL_SHARED_TAGS_ACCESS' => 'Shared tags are accessible by all users in nectarcrm',
  ...
  'LBL_TO_USE_SWITCH_TO_NEW_LOOK' => 'To use <b>%s</b>, we recommend you to Switch to new look.',
	...
	'LBL_DUPLICATES_FOUND_MESSAGE' => 'This %s cannot be saved since duplicate %s exists in nectarcrm with matching values for %s.',
	'LBL_NECTARCRM_NOTIFICATION' => 'Message from : nectarcrm System Notifications',
...
$jsLanguageStrings = array(
    ...
    'JS_CURRENCY_TOOLTIP_CONTENT_MESSAGE' => 'For importing Currency values in Line items, nectarcrm will use this setting to identify the currency. Any currency values outside the line items tables, are assumed to be in User\'s preferred currency (selected in \'My Preferences\')',
	...
	'JS_SUITABLE_NECTARCRM_FIELD_NOT_AVAILABLE_FOR_MAPPING' => 'Suitable nectarcrm field not available for mapping',
    ...
    'OFFICE365_REMOVE_SYNCHRONIZATION_MESSAGE' => 'Clicking on this will remove existing Office365 authentication. It will not delete any records which are already synchronised. It will not unregister the nectarcrm app from you office365 account, to unregister visit https://myapps.microsoft.com/',
  ...
  'LBL_DELETE_USER_CONFIRMATION' => 'When a User is deleted, the user will be marked as "Inactive" and no new records can be assigned to the User, and the user will not be able to login. Billing will stop for this user.If you need to reactivate a deleted user, you will need to send email to support@nectarcrm.com.Are you sure you want to delete?',
  ...
  'JS_REACTIVATED_SUCCESSFULLY' => 'nectarcrm Subscription reactivated successfully',
  ...
  'JS_MORE_NECTARCRM' => 'There are more records to be synchronised in nectarcrm',
