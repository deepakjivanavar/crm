...
$languageStrings = array(
    ...
    'LBL_MAILCONVERTER_DESCRIPTION'   =>   "Mail Converter consente di configurare la tua casella di posta per eseguire la scansione dei messaggi di posta elettronica e creare entità appropriate in nectarcrm CRM. <br> Sarà inoltre necessario definire le regole per specificare quali azioni devono essere eseguite sui vostri email. <br> Le tue email scansionata automaticamente, a meno che non hai disattivato attività Stampa Scanner in Scheduler. <br> <br> <br>",
    ...
    'LBL_EMAIL_BODY_INFO' => 'Copiare testo da un messaggio del campione da sottoporre a scansione nella casella qui sotto. nectarcrm CRM cercherà di individuare i valori e aiutare a mappare i campi di CRM.',
