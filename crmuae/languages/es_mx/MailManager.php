...
$languageStrings = array(
	...
	'LBL_MODULE_DESCRIPTION'   => 'El Administrador de correo es un cliente de correo integrado que le permite a los usuarios llevar a cabo acciones relacionadas con el CRM en el correo electrónico que reciben. El Administrador le ayuda a crear Prospectos, Contactos, Cuentas, Casos y Tareas a partir de los correos que llegan a su buzón. Si la ID del remitente del correo corresponde con un registro en su nectarcrm CRM, puede hacer cosas como Anexar un correo, Agregar una Tarea, Comentar y levantar un Caso. Además, puede administrar tareas como redactar, responder y reenviar correos, entre muchas cosas más.',
