...
$languageStrings = array(
	...
	'replied' => 'cevaplandı',
	'reply' => 'Cevaplandı',
	'customer_portal' => 'nectarcrmın Müşteri Detek Portalı.',
	'link' => 'Cevapları izlemek için bu linki izleyiniz:',
	'Thanks' => 'Teşekkürler',
	'Support_team' => 'nectarcrmTurkey Destek Takımı',

	//this label for customerportal.
	'LBL_STATUS_CLOSED' => 'Closed',//Do not convert this label. This is used to check the status. If the status 'Closed' is changed in nectarcrmCRM server side then you have to change in customerportal language file also.
