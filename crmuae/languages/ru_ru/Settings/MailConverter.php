...
$languageStrings = array(
    ...
    'LBL_EMAIL_BODY_INFO' => 'Копирование текста с образца электронной почте, которые будут проверяться в ниже окне. nectarcrm CRM будет пытаться найти значения и поможет вам карту, чтобы CRM полей.',
