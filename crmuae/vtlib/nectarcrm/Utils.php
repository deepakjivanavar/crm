 ...
 * @package vtlib
 */
class nectarcrm_Utils {
    protected static $logFileName = 'nectarcrmmodule.log';
	...
	static function Log($message, $delimit=true) {
		global $nectarcrm_Utils_Log, $log;
		
		$log->debug($message);
		if(!isset($nectarcrm_Utils_Log) || $nectarcrm_Utils_Log == false) return;
	...
	static function CheckTable($tablename) {
		...
		$tablename = nectarcrm_Utils::SQLEscape($tablename);
