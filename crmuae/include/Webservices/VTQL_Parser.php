...
#line 451 "e:\workspace\nonadmin\pkg\nectarcrm\extensions\Webservices\VTQL_parser.y"
class VTQL_Parser#line 102 "e:\workspace\nonadmin\pkg\nectarcrm\extensions\Webservices\VTQL_parser.php"
{
...
Array ( 
	...
	[tableName] => nectarcrm_crmentity,nectarcrm_contactdetails,nectarcrm_contactaddress,nectarcrm_contactsubdetails,nectarcrm_contactscf,nectarcrm_customerdetails 
...
if($firstTable!=$table){
	if(!isset($tabNameIndex[$table]) && $table == "nectarcrm_crmentity"){
        ...
        if($this->user && nectarcrm_Functions::isUserSpecificFieldTable($table, $module)) {
