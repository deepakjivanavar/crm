...
class Import_Map_Model extends nectarcrm_Base_Model {

	static $tableName = 'nectarcrm_import_maps';
	var $map;
	var $user;
	...
	public static function markAsDeleted($mapId) {
		...
		$db->pquery('UPDATE nectarcrm_import_maps SET deleted=1 WHERE id=?', array($mapId));
	}
