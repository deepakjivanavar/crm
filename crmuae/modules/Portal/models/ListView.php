 ...
 */
class Portal_ListView_Model extends nectarcrm_ListView_Model {
    
	public function getListViewEntries($pagingModel) {
        $db = PearDatabase::getInstance();
        $moduleModel = nectarcrm_Module_Model::getInstance('Portal');
        ...
        for($i = 0; $i < $db->num_rows($listResult); $i++) {
            ...
            $listViewEntries[$row['portalid']]['createdtime'] = nectarcrm_Date_UIType::getDisplayDateValue($row['createdtime']);
        }
    ...
    public function getQuery() {
        $query = 'SELECT portalid, portalname, portalurl, createdtime FROM nectarcrm_portal';
