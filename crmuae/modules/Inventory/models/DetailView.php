...
class Inventory_DetailView_Model extends nectarcrm_DetailView_Model {
	...
	public function getDetailViewLinks($linkParams) {
		...
		if(Users_Privileges_Model::isPermitted($moduleName, 'DetailView', $recordModel->getId())) {
			...
			$linkModelList['DETAILVIEW'][] = nectarcrm_Link_Model::getInstanceFromValues($detailViewLinks);
            ...
            $linkModelList['DETAILVIEW'][] = nectarcrm_Link_Model::getInstanceFromValues($sendEmailLink);
		}
