...
class Inventory_Charges_Model extends nectarcrm_Base_Model {

	const CHARGES_TABLE_NAME = 'nectarcrm_inventorycharges';
	...
	public static function getCreateChargeUrl() {
		return '?module=nectarcrm&parent=Settings&view=TaxAjax&mode=editCharge';
	}

	public function getEditChargeUrl() {
		return '?module=nectarcrm&parent=Settings&view=TaxAjax&mode=editCharge&chargeId='.$this->getId();
	}

	public function getDeleteChargeUrl() {
		return '?module=nectarcrm&parent=Settings&action=TaxAjax&mode=deleteCharge&chargeId='.$this->getId();
	}
