...
class Settings_nectarcrm_OutgoingServerDetail_View extends Settings_nectarcrm_Index_View {
    ...
    public function process(nectarcrm_Request $request) {
		...
		$viewer->assign('OD_DEFAULT_MAIL_SERVER_IP', nectarcrmConfig::getOD('OD_DEFAULT_MAIL_SERVER_IP'));
