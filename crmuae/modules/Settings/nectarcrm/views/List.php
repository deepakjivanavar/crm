...
class Settings_nectarcrm_List_View extends Settings_nectarcrm_Index_View {
	...
	function getHeaderScripts(nectarcrm_Request $request) {
		...
		$jsFileNames = array(
			...
			"modules.Settings.nectarcrm.resources.$moduleName",
    ...
    public function setModuleInfo($request, $moduleModel){
        ...
        $viewer = $this->getViewer($request);
        $listViewModel = Settings_nectarcrm_ListView_Model::getInstance($request->getModule(false));
