...
class Settings_nectarcrm_CompanyDetails_Model extends Settings_nectarcrm_Module_Model {

	STATIC $logoSupportedFormats = array('jpeg', 'jpg', 'png', 'gif', 'pjpeg', 'x-png');

	var $baseTable = 'nectarcrm_organizationdetails';
	...
	public function getEditViewUrl() {
		return 'index.php?module=nectarcrm&parent=Settings&view=CompanyDetailsEdit';
	}
	...
	public function getMenuItem() {
		$menuItem = Settings_nectarcrm_MenuItem_Model::getInstance('LBL_COMPANY_DETAILS');
		return $menuItem;
	}
	...
	public function getIndexViewUrl() {
		...
		return 'index.php?module=nectarcrm&parent=Settings&view=CompanyDetails&block='.$menuItem->get('blockid').'&fieldid='.$menuItem->get('fieldid');
	}
	 ...
	 * @return <Settings_nectarcrm_CompanyDetais_Model> $moduleModel
	 */
	public static function getInstance($name = '') {
		$moduleModel = new self();
		$db = PearDatabase::getInstance();

		$result = $db->pquery("SELECT * FROM nectarcrm_organizationdetails", array());
