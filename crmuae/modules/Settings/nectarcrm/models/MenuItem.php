...
/*
 * nectarcrm Settings MenuItem Model Class
 */
class Settings_nectarcrm_MenuItem_Model extends nectarcrm_Base_Model {

	protected static $itemsTable = 'nectarcrm_settings_field';
	 ...
	 * @return Settings_nectarcrm_Menu_Model instance
	 */
	 ...
	 * @param <Number> $menuId
	 * @return Settings_nectarcrm_MenuItem_Model
	 */
	public function setMenu($menuId) {
		$this->menu = Settings_nectarcrm_Menu_Model::getInstanceById($menuId);
		return $this;
	}

	/**
	 * Function to set the Menu to which the Item belongs, given Menu Model instance
	 * @param <Settings_nectarcrm_Menu_Model> $menu - Settings Menu Model instance
	 * @return Settings_nectarcrm_MenuItem_Model
	 */
	...
	public function getModuleName() {
		return 'Settings:nectarcrm';
	}
    /**
	 *  Function to get the pin and unpin action url
	 */
	public function getPinUnpinActionUrl() {
		return 'index.php?module=nectarcrm&parent=Settings&action=Basic&mode=updateFieldPinnedStatus&fieldid='.$this->getId();
	}
	 ...
	 * @return Settings_nectarcrm_MenuItem_Model instance
	 */
	 ...
	 * @param <String> $name
	 * @param <Settings_nectarcrm_Menu_Model> $menuModel
	 * @return Settings_nectarcrm_MenuItem_Model instance
	 */
	public static function getInstance($name, $menuModel=false) {
		...
		if($db->num_rows($result) > 0) {
			...
			$menuItem = Settings_nectarcrm_MenuItem_Model::getInstanceFromArray($rowData);
			if($menuModel) {
	 ...
	 * @param <Settings_nectarcrm_Menu_Model> $menuModel
	 * @return <Array> - List of Settings_nectarcrm_MenuItem_Model instances
	 */
