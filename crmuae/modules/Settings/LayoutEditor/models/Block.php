...
class Settings_LayoutEditor_Block_Model extends nectarcrm_Block_Model {
    ...
    public static function updateFieldSequenceNumber($blockFieldSequence, $moduleModel = false) {
        ...
        $query = 'UPDATE nectarcrm_field SET ';
        $query .=' sequence= CASE ';
        ...
        // Clearing cache
        nectarcrm_Cache::flushModuleandBlockFieldsCache($moduleModel);
    }
