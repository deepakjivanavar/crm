...
class Settings_Workflows_RecordStructure_Model extends nectarcrm_RecordStructure_Model {
	...
	public static function getInstanceForWorkFlowModule($workFlowModel, $mode) {
		$className = nectarcrm_Loader::getComponentClassName('Model', $mode.'RecordStructure', 'Settings:Workflows');
