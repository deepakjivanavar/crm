...
vimport('~~/vtlib/nectarcrm/Net/Client.php');
vimport('~~/vtlib/nectarcrm/Package.php');

class Settings_ModuleManager_Extension_Model extends nectarcrm_Base_Model {
	...
	public function isnectarcrmCompatible() {
		...
		if ((nectarcrm_Version::check($nectarcrmVersion, '>=') && $nectarcrmMaxVersion && nectarcrm_Version::check($nectarcrmMaxVersion, '<'))
				|| nectarcrm_Version::check($nectarcrmVersion, '=')) {
			return true;
		}
		return false;
	}
	...
	public function installTrackDetails() {
		...
		$client = new nectarcrm_Net_Client(self::getExtensionsManagerUrl() . '/api.php');
	...
	public static function getAll() {
		...
		if ($extensionLookUpUrl) {
			$clientModel = new nectarcrm_Net_Client($extensionLookUpUrl);
	...
	public static function download($extensionId, $targetFileName) {
		...
		if ($downloadURL) {
			$clientModel = new nectarcrm_Net_Client($downloadURL);
