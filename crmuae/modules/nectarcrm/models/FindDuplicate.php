...
class nectarcrm_FindDuplicate_Model extends nectarcrm_Base_Model {
	...
	function getListViewHeaders() {
		...
		$listViewHeaders[] = new nectarcrm_Base_Model(array('name' => 'recordid', 'label' => 'Record Id'));
	...
	function getListViewEntries(nectarcrm_Paging_Model $paging) {
        $db = PearDatabase::getInstance();
        $moduleModel = $this->getModule();
    ...
    public function getMassDeleteRecords(nectarcrm_Request $request) {
        $db = PearDatabase::getInstance();
