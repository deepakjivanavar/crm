...
/**
 * nectarcrm Menu Model Class
 */
class nectarcrm_Menu_Model extends nectarcrm_Module_Model {
	...
	public static function getAllForQuickCreate() {
		...
		uksort($menuModels, array('nectarcrm_MenuStructure_Model', 'sortMenuItemsByProcess'));
		return $menuModels;
	}
