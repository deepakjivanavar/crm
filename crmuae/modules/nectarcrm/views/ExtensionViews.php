...
class nectarcrm_ExtensionViews_View extends nectarcrm_Index_View {
	...
	function showLogs(nectarcrm_Request $request) {
	...
	function showLogDetail(nectarcrm_Request $request) {
