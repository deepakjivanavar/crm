...
class PBXManager_Server_Model extends nectarcrm_Base_Model{

    const tableName = 'nectarcrm_pbxmanager_gateway';
    ...
    public static function generatenectarcrmSecretKey() {
        return uniqid(rand());
    }
