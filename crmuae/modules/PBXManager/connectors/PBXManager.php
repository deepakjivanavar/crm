...
class PBXManager_PBXManager_Connector {
    ...
    private static $SETTINGS_REQUIRED_PARAMETERS = array('webappurl' => 'text','outboundcontext' => 'text', 'outboundtrunk' => 'text' , 'nectarcrmsecretkey' => 'text');
    ...
    public function getnectarcrmSecretKey() {
        return $this->nectarcrmsecretkey;
    }
    ...
    public function setServerParameters($serverModel) {
        ...
        $this->nectarcrmsecretkey = $serverModel->get('nectarcrmsecretkey');
    }
     ...
     * @param <nectarcrm_Request> $details 
     */
