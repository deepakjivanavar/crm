...
class PBXManager_IncomingCallPoll_Action extends nectarcrm_Action_Controller{
    ...
    public function checkModuleViewPermission(nectarcrm_Request $request){
    ...
    public function searchIncomingCalls(nectarcrm_Request $request){
   ...
   public function createRecord(nectarcrm_Request $request){
            $user = Users_Record_Model::getCurrentUserModel();
            ...
            foreach($mandatoryFieldModels as $mandatoryField){
                ...
                if(!empty($element[$fieldName])){
                    ...
                    if(empty($fieldValue)) {
                        $fieldValue = nectarcrm_Util_Helper::getDefaultMandatoryValue($fieldType);
                    }
    ...
    function checkPermissionForPolling(nectarcrm_Request $request) {
        Users_Privileges_Model::getCurrentUserPrivilegesModel();
