...
class CustomerPortal_ForgotPassword extends CustomerPortal_API_Abstract {
	...
	function process(CustomerPortal_API_Request $request) {
		...
		$sql = 'SELECT * FROM nectarcrm_portalinfo
					INNER JOIN nectarcrm_contactdetails ON nectarcrm_contactdetails.contactid=nectarcrm_portalinfo.id
					INNER JOIN nectarcrm_customerdetails ON nectarcrm_customerdetails.customerid=nectarcrm_portalinfo.id
					INNER JOIN nectarcrm_crmentity ON nectarcrm_portalinfo.id=nectarcrm_crmentity.crmid 
						WHERE nectarcrm_portalinfo.user_name = ? AND nectarcrm_crmentity.deleted= ?
						AND nectarcrm_customerdetails.support_start_date <= ?';
