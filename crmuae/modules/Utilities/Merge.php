...
// Fix For: http://trac.nectarcrm.com/cgi-bin/trac.cgi/ticket/2107
...
$sql = "select filename,data,filesize from nectarcrm_wordtemplatestorage where filename=?";
...
<OBJECT Name="nectarcrmVM" codebase="http://<?php echo $_SERVER["HTTP_HOST"] ?>/modules/Settings/nectarcrmVM.CAB#Version1,0,0,1"
