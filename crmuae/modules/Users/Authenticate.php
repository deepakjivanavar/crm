 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /advent/projects/wesat/nectarcrm_crm/sugarcrm/modules/Users/Authenticate.php,v 1.10 2005/02/28 05:25:22 jack Exp $
...
if($focus->is_authenticated()) {
	...
	$_SESSION['nectarcrm_authenticated_user_theme'] = $authenticated_user_theme;
	...
	$sql = 'select user_name, id, crypt_type from nectarcrm_users where user_name=?';
