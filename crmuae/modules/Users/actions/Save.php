...
class Users_Save_Action extends nectarcrm_Save_Action {
	...
	public function process(nectarcrm_Request $request) {
		...
		if ($request->get('relationOperation')) {
			$parentRecordModel = nectarcrm_Record_Model::getInstanceById($request->get('sourceRecord'), $request->get('sourceModule'));
