...
function vtJsonDependentModules($adb, $request) {
	...
	$result = $adb->pquery("SELECT fieldname, tabid, typeofdata, nectarcrm_ws_referencetype.type as reference_module FROM nectarcrm_field
									INNER JOIN nectarcrm_ws_fieldtype ON nectarcrm_field.uitype = nectarcrm_ws_fieldtype.uitype
									INNER JOIN nectarcrm_ws_referencetype ON nectarcrm_ws_fieldtype.fieldtypeid = nectarcrm_ws_referencetype.fieldtypeid
							UNION
							SELECT fieldname, tabid, typeofdata, relmodule as reference_module FROM nectarcrm_field
									INNER JOIN nectarcrm_fieldmodulerel ON nectarcrm_field.fieldid = nectarcrm_fieldmodulerel.fieldid", array());
