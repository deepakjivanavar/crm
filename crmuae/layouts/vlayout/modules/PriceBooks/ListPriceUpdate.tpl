	...
	<form class="form-horizontal" id="listPriceUpdate" method="post" action="index.php">
		...
		<div class="modal-body">
			<div>
				...
				&nbsp;:&nbsp;
				<input type="text" name="currentPrice" value="{$CURRENT_PRICE}" data-validation-engine="validate[required,funcCall[nectarcrm_Currency_Validator_Js.invokeValidation]]" 
