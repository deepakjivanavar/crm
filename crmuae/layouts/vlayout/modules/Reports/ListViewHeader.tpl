						...
						<span class="btn-group">
							...
							<ul class="dropdown-menu">
								{foreach item="childLink" from=$childLinks}
									<li id="{$MODULE}_listView_basicAction_{nectarcrm_Util_Helper::replaceSpaceWithUnderScores($childLink->getLabel())}">
