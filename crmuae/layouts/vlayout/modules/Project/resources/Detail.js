...
nectarcrm_Detail_Js("Project_Detail_Js",{},{
	...
	registerStatusChangeEventForWidget : function(){
		...
		jQuery('[name="ticketstatus"],[name="projecttaskstatus"],[name="projecttaskprogress"]').on('change',function(e){
			...
			if(selectedStatus != "Select Status" && referenceModuleName == "HelpDesk"){
				statusCondition['nectarcrm_troubletickets.status'] = selectedStatus;
				...
				statusCondition['nectarcrm_projecttask.projecttaskstatus'] = selectedStatus;
				params['whereCondition'] = statusCondition;
			}
				...
				statusCondition['nectarcrm_projecttask.projecttaskprogress'] = selectedStatus;
				params['whereCondition'] = statusCondition;
			}
