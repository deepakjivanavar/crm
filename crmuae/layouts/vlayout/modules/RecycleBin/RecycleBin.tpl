...
{include file='Buttons_List.tpl'}
                                <div id="searchingUI" style="display:none;">
                                        ...
                                        <tr>
                                                <td align=center>
                                                <img src="{'searching.gif'|@nectarcrm_imageurl:$THEME}" alt="{$APP.LBL_SEARCHING}"  title="{$APP.LBL_SEARCHING}">
                                                </td>
                                        </tr>
                                        </table>
...
<tr><td valign=top><img src="{'showPanelTopLeft.gif'|@nectarcrm_imageurl:$THEME}"></td>
...
{*<!-- Searching UI -->*}
	  ...
	  <div id="modules_datas" class="small" style="width:100%;">
        ...
        <td valign="top"><img src="{'showPanelTopRight.gif'|@nectarcrm_imageurl:$THEME}"></td>
   </tr>
</tbody>
</table>
