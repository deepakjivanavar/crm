	...
	<div class="bottomscroll-div">
		<table class="table table-bordered listViewEntriesTable">
			...
			<tr class="listViewEntries" data-id="{$LISTVIEW_ENTRY->getId()}" data-name='{$LISTVIEW_ENTRY->getName()}'
				...
				<td class="listViewEntryValue {$WIDTHTYPE}">
					<div class="row-fluid">
						<input type="text" value="{$LISTVIEW_ENTRY->get('unit_price')}" name="listPrice" class="invisible span10 zeroPaddingAndMargin" data-validation-engine="validate[required,funcCall[nectarcrm_Currency_Validator_Js.invokeValidation]]"
