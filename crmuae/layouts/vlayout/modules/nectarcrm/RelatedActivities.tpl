		...
		{if count($ACTIVITIES) neq '0'}
			{foreach item=RECORD key=KEY from=$ACTIVITIES}
				...
				<div class="activityEntries">
					...
					<div class="row-fluid">
						<span class="span6"><strong title="{nectarcrm_Util_Helper::formatDateTimeIntoDayString("$START_DATE $START_TIME")}">{nectarcrm_Util_Helper::formatDateIntoStrings($START_DATE, $START_TIME)}</strong></span>
