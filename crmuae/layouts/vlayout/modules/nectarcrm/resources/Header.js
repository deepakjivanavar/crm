...
jQuery.Class("nectarcrm_Header_Js", {
    ...
    getInstance: function() {
        ...
        this.self = new nectarcrm_Header_Js();
        return this.self;
    }
}, {
    menuContainer: false,
    ...
    getQuickCreateForm: function(url, moduleName, params) {
        ...
        if ((!params.noCache) || (typeof (params.noCache) == "undefined")) {
            if (typeof nectarcrm_Header_Js.quickCreateModuleCache[moduleName] != 'undefined') {
                aDeferred.resolve(nectarcrm_Header_Js.quickCreateModuleCache[moduleName]);
        ...
        AppConnector.request(requestParams).then(function(data) {
            if ((!params.noCache) || (typeof (params.noCache) == "undefined")) {
                nectarcrm_Header_Js.quickCreateModuleCache[moduleName] = data;
            }
...
//        }
    ...
    registerCalendarButtonClickEvent: function() {
        ...
        var nectarcrmDateFormat = app.convertToDatePickerFormat(dateFormat);
    ...
    handleQuickCreateData: function(data, params) {
        ...
        app.showModalWindow(data, function(data) {
            ...
            var editViewInstance = nectarcrm_Edit_Js.getInstanceByModuleName(moduleName);
        ...
        form.on('submit', function(e) {
            ...
            if (typeof form.data('submit') != "undefined") {
                ...
                if (!(recordPreSaveEvent.isDefaultPrevented())) {
                    ...
                    var moduleInstance = nectarcrm_Edit_Js.getInstanceByModuleName(module);
    ...
    labelSearch: function(currentTarget) {
        ...
        var basicSearch = new nectarcrm_BasicSearch_Js();
    ...
    registerEvents: function() {
		...
		if(jQuery.browser.msie && jQuery.browser.version < 9.0) {
			if(app.getCookie('oldbrowser') != 'true') {
				...
				window.location.href = 'layouts/vlayout/modules/nectarcrm/browsercompatibility/Browser_compatibility.html';
			}
		}
		...
		$(document).ajaxComplete(function() {
			 nectarcrm_Header_Js.getInstance().adjustContentHeight();
		});
...
jQuery(document).ready(function() {
    ...
    nectarcrm_Header_Js.getInstance().registerEvents();
