...
jQuery.Class('nectarcrm_Widget_Js',{
	...
	refreshWidget : function() {
		...
		AppConnector.request(params).then(
			function(data){
				...
				contentContainer.html(data).trigger(nectarcrm_Widget_Js.widgetPostRefereshEvent);
			},
			function(){
				refreshContainer.progressIndicator({'mode': 'hide'});
			}
	...
	registerWidgetPostLoadEvent : function(container) {
		var thisInstance = this;
		container.on(nectarcrm_Widget_Js.widgetPostLoadEvent, function(e) {
