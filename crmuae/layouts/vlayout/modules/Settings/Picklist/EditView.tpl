	...
	<form id="renameItemForm" class="form-horizontal" method="post" action="index.php">
		...
		<div class="modal-body tabbable">
			<div class="control-group">
				...
				<div class="controls"><input type="text" data-validation-engine="validate[required, funcCall[nectarcrm_Base_Validator_Js.invokeValidation]]" data-validator={Zend_Json::encode([['name'=>'FieldLabel']])} name="newValue"></div>
