...
jQuery.Class('Settings_LayoutEditor_Js', {
	...
	updateBlockSequence : function() {
		...
		AppConnector.request(params).then(
			function(data) {
				...
				Settings_nectarcrm_Index_Js.showMessage(params);
			},
			function(error) {
				progressIndicatorElement.progressIndicator({'mode' : 'hide'});
			}
	...
	setFieldDetails : function(result, form) {
		...
		var fieldModel = nectarcrm_Field_Js.getInstance(result);
		...
		defaultValueUi.find('[data-validation-engine]').attr('data-validation-engine','validate[required,funcCall[nectarcrm_Base_Validator_Js.invokeValidation]]');
...
nectarcrm_WholeNumberGreaterThanZero_Validator_Js("nectarcrm_FloatingDigits_Validator_Js",{
	...
	invokeValidation: function(field, rules, i, options){
		var rangeInstance = new nectarcrm_FloatingDigits_Validator_Js();
...
nectarcrm_WholeNumberGreaterThanZero_Validator_Js("nectarcrm_DecimalMaxLength_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var rangeInstance = new nectarcrm_DecimalMaxLength_Validator_Js();
		rangeInstance.setElement(field);
		var response = rangeInstance.validate();
		if(response != true){
			return rangeInstance.getError();
...
nectarcrm_WholeNumberGreaterThanZero_Validator_Js("nectarcrm_MaxLength_Validator_Js",{
...
nectarcrm_Base_Validator_Js("nectarcrm_FieldLabel_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var instance = new nectarcrm_FieldLabel_Validator_Js();
...
nectarcrm_Base_Validator_Js("nectarcrm_PicklistFieldValues_Validator_Js",{
	 ...
	 */
	invokeValidation: function(field, rules, i, options){
		var instance = new nectarcrm_PicklistFieldValues_Validator_Js();
		instance.setElement(field);
		var response = instance.validate();
		if(response != true){
			return instance.getError();
