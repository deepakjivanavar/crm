...
<div class="row-fluid main-container">
	<div class="inner-container">
		...
		<form class="form-horizontal" name="step2" method="get" action="index.php">
			...
			<div class="span12">
				...
				<div class="lic-scroll">
					...
					<br>
					The nectarcrm Public License Version 1.2 is based on the Mozilla Public License Version 1.1 with the additional terms in Exhibit B. The original Mozilla Public License 1.1 can be found at: http://www.mozilla.org/MPL/MPL-1.1.html
					<br>
					nectarcrm Public License
					Version 1.2
					<br><br>
					Copyright (c) 2004-2013 www.nectarcrm.com All rights reserved.
					<br><br>
					<!--
     ...
     If You create or use a modified version of this License (which you may only do in order to apply it to code which is not already Covered Code governed by this License), You must (a) rename Your license so that the phrases "nectarcrm'or any confusingly similar phrase do not appear in your license (except to note that your license differs from this License) and (b) otherwise make it clear that Your version of the license contains terms which differ from the nectarcrm Public License. (Filling in the name of the Initial Developer, Original Code or Contributor in the notice described in Exhibit A shall not of themselves be deemed to be modifications of this License.)
					...
					<br><br>
					"The contents of this file are subject to the nectarcrm Public License Version 1.1 (the "License"); you may not use this file except in compliance with the License."
					<br><br>
					Software distributed under the License is distributed on an "AS IS" basis, WITHOUT WARRANTY OF ANY KIND, either express or implied. See the License for the specific language governing rights and limitations under the License.
					<br><br>
					The Original Code is nectarcrm.
					<br><br>
					The Initial Developer of the Original Code is nectarcrm. Portions created by  nectarcrm are Copyright (C) www.nectarcrm.com. All Rights Reserved.
					<br><br>
					Contributor(s): ______________________________________.
					<br><br>
					[NOTE: The text of this Exhibit A may differ slightly from the text of the notices in the Source Code files of the Original Code. You should use the text of this Exhibit A rather than the text found in the Original Code Source Code for Your Modifications.]
					<br><br>
					EXHIBIT B - nectarcrm CRM and Logo
					<br><br>
					This License does not grant any rights to use the trademarks "nectarcrm" and "nectarcrm CRM" and "nectarcrm" logos even if such marks are included in the Original Code or Modifications.
					<br><br>
				</div>
				</div>
			</div>
