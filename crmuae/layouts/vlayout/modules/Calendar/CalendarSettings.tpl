            ...
            <div name="contents">
                <div class="row-fluid">
                    ...
                    <div class="span10">
                        ...
                        {assign var=EVENTS_MODULE_MODEL value=nectarcrm_Module_Model::getInstance('Events')}
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <select class="select2" style="min-width: 133px" name="{$DEFAULT_ACTIVITY_TYPE_MODEL->get('name')}">
                                    <option value="{vtranslate('LBL_SELECT_OPTION','nectarcrm')}">{vtranslate('LBL_SELECT_OPTION','nectarcrm')}</option>
