...
nectarcrm_Helper_Js.showHorizontalTopScrollBar = function (container) {
	app.helper.showHorizontalScroll(container);
};

nectarcrm_Helper_Js.showPnotify = function (params) {
...
nectarcrm_Helper_Js.showMessage = function (params) {
	nectarcrm_Helper_Js.showPnotify(params);
};

nectarcrm_List_Js.prototype.registerTimeListSearch = function (container) {
	vtUtils.registerEventForTimeFields(container);
};

nectarcrm_List_Js.prototype.registerDateListSearch = function (container) {
	vtUtils.registerEventForDateFields(container);
};

nectarcrm_List_Js.prototype.calculatePages = function () {
...
nectarcrm_List_Js.prototype.checkSelectAll = function () {
	var state = true;
...
nectarcrm_List_Js.prototype.registerChangeCustomFilterEvent = function () {
	var thisInstance = this;
...
nectarcrm_List_Js.prototype.getListViewContentContainer = function () {
	return this.getListViewContainer();
};

nectarcrm_Popup_Js.prototype.show = function (params, callback) {
...
nectarcrm_Popup_Js.prototype.calculatePages = function () {
	var thisInstance = this;
	var aDeferred = jQuery.Deferred();
	var totalNumberOfRecords = jQuery('.totalNumberOfRecords');
	thisInstance.totalNumOfRecords(totalNumberOfRecords);
