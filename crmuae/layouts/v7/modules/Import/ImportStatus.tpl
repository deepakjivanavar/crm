...
<div class='fc-overlay-modal' id="scheduleImportStatus">
    <div class = "modal-content">
        ...
        <div class='modal-body' id = "importStatusDiv" style="margin-bottom:100%">
            <hr>
                <form onsubmit="nectarcrmJS_DialogBox.block();" action="index.php" enctype="multipart/form-data" method="POST" name="importStatusForm" id = "importStatusForm">
            ...
            <div class="row clearfix">
                <div class='textAlignCenter col-lg-12 col-md-12 col-sm-12 '>
                    <button name="cancel" class="btn btn-danger btn-lg"
                            onclick="return nectarcrm_Import_Js.cancelImport('index.php?module={$FOR_MODULE}&view=Import&mode=cancelImport&import_id={$IMPORT_ID}')">{'LBL_CANCEL_IMPORT'|@vtranslate:$MODULE}</button>
                </div>
            </div>
        </div>
    </div>
