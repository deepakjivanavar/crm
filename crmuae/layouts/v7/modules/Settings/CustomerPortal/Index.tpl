	...
	<div class="listViewPageDiv" id="listViewContent">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<form id="customerPortalForm" name="customerPortalForm" action="index.php" method="POST" class="form-horizontal">
				...
				{* Mahesh Edit hide cusomer portal url <div class="col-sm-12 col-xs-12 input-group">
					<div class="form-group">
						<label for="portal-url" class="col-sm-4 control-label fieldLabel">{vtranslate('LBL_PORTAL_URL', $QUALIFIED_MODULE)}</label>
						<div class="col-sm-5">
							<a target="_blank" href="{$PORTAL_URL}" class="help-inline" style="width: 341px;color:blue;">{$PORTAL_URL}</a>
				...
				<div class="row" style="margin-bottom: 100px;">
					...
					<div class="col-sm-9 portal-dashboard">
						<div id="dashboardContent" class="show" >
							...
							<hr class="hrHeader">
							<input type="hidden" name="defaultWidgets" value='{nectarcrm_Functions::jsonEncode($WIDGETS,true)}'/>
