...
-->*}
{strip}
    {include file="ListViewContents.tpl"|vtemplate_path:'Settings:nectarcrm'}
                ...
                <div class='col-lg-8'>
                    ...
                    <div class="checkbox">
                        <label>
                            ...
                            <input type="checkbox" name="visibility" value="{nectarcrm_Tag_Model::PUBLIC_TYPE}" style="vertical-align: text-top;"/>
