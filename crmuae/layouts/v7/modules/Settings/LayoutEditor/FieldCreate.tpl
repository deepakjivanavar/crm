				...
				<div class="modal-body model-body-scrollenabled">
					...
					<div class="well fieldProperty">
						<div class="properties">
							<div class="row">
								<div class="form-group">
									<label class="control-label fieldLabel col-sm-5" style="width: 55.666667%!important;">
							...
							<div class="row">
								<div class="form-group col-sm-7">
									<label class="control-label fieldLabel col-sm-10" style="width: 55.666667%!important;">
								...
								<div class="form-group col-sm-6">
									<label class="control-label fieldLabel col-sm-7" style="width: 55.666667%!important;">
