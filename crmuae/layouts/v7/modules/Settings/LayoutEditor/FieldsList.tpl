...
{strip}
	...
	<input type="hidden" class="inActiveFieldsArray" value='{nectarcrm_Functions::jsonEncode($IN_ACTIVE_FIELDS)}' />
	<input type="hidden" id="headerFieldsCount" value="{$HEADER_FIELDS_COUNT}">
	<input type="hidden" id="nameFields" value='{nectarcrm_Functions::jsonEncode($SELECTED_MODULE_MODEL->getNameFields())}'>
	<input type="hidden" id="headerFieldsMeta" value='{nectarcrm_Functions::jsonEncode($HEADER_FIELDS_META)}'>
