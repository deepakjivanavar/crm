 ...
 * All Rights Reserved.
 ************************************************************************************}
{* modules/Settings/nectarcrm/views/TaxAjax.php *}
            ...
            <form id="editCharge" class="form-horizontal">
                ...
                <div class="modal-body" id="scrollContainer">
                    <div class="">
                        ...
                        <div style="padding: 0px 40px;"><i class="fa fa-info-circle"></i> {vtranslate('LBL_CHARGE_STORE_DISC', $QUALIFIED_MODULE)} ({nectarcrm_Functions::getCurrencyName(CurrencyField::getDBCurrencyId())})</div>
                        <br><br>
                    </div>
                </div>
