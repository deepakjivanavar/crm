...
nectarcrm_Index_Js("Settings_nectarcrm_Index_Js",{
				...
				if(data.SUCCESS == 'OK') {
					if (shortCutElementActionStatus == 'pin') {
						...
						if (shortCutsMainContainer.length > 0) {
							var url = 'module=nectarcrm&parent=Settings&view=IndexAjax&mode=getSettingsShortCutBlock&fieldid='+shortCutActionEle.data('id');
