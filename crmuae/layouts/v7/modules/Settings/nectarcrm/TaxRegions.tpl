 ...
 * All Rights Reserved.
 ************************************************************************************}
{* modules/Settings/nectarcrm/views/TaxIndex.php *}
		...
		<div class="tab-content overflowVisible">
			...
			<div class="col-lg-4 marginLeftZero textOverflowEllipsis">
				<div class="marginBottom10px">
					<button type="button" class="btn btn-default addRegion addButton module-buttons" data-url="?module=nectarcrm&parent=Settings&view=TaxAjax&mode=editTaxRegion" data-type="1">
