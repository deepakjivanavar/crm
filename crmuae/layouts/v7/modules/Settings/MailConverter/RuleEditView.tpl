								...
								<tr class="row">
									...
									<td class="col-lg-4">
										...
										{elseif $FIELD_DATA_TYPE eq 'email'}
											<input type="text" class="fieldValue inputElement" name="{$FIELD_MODEL->getName()}" value="{$RECORD_MODEL->get($FIELD_NAME)}" data-validation-engine="validate[funcCall[nectarcrm_Email_Validator_Js.invokeValidation]]"/>
										{else}
