...
{assign var="PRIVATE_COMMENT_MODULES" value=nectarcrm_Functions::getPrivateCommentModules()}
										...
										<div class="media-body" style="width:100%">
											<div class="comment" style="line-height:1;">
												...
												<span class="commentTime text-muted cursorDefault">
													<small title="{nectarcrm_Util_Helper::formatDateTimeIntoDayString($COMMENT->getCommentedTime())}">{nectarcrm_Util_Helper::formatDateDiffInStrings($COMMENT->getCommentedTime())}</small>
												</span>
													...
													{if !empty($FILE_NAME)}
														<div class="commentAttachmentName">
															<div class="filePreview clearfix">
																...
																<a class="previewfile" onclick="nectarcrm_Detail_Js.previewFile(event,{$COMMENT->get('id')},{$FILE_DETAIL['attachmentId']});" data-filename="{$FILE_NAME}" href="javascript:void(0)" name="viewfile" style="color: blue;">
													...
													<div class="row commentEditStatus" name="editStatus">
														...
														<span {if $REASON_TO_EDIT}class="col-lg-7 col-md-7 col-sm-7"{/if}>
															<p class="text-muted pull-right" {if !$REASON_TO_EDIT}style="margin-right: 15px;"{/if}>
																...
																<small title="{nectarcrm_Util_Helper::formatDateTimeIntoDayString($COMMENT->getModifiedTime())}" class="commentModifiedTime">{nectarcrm_Util_Helper::formatDateDiffInStrings($COMMENT->getModifiedTime())}</small>
															</p>
														</span>
													</div>
												{/if}
