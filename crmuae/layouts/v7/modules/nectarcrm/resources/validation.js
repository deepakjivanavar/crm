...
jQuery.Class('nectarcrm_Validations_Helper', {
	getInstance : function() {
		return new nectarcrm_Validations_Helper();
	}
},{ 
...
jQuery.validator.addMethod("greaterThanDependentField", function(value, element, params) {
	var helper = nectarcrm_Validations_Helper.getInstance();
	...
	*/
	...
	$.fn.vtValidate = function(params) {
		...
		errorPlacement: function(error, element) {
			if($(error).text()) {
				...
				element.qtip({
					...
					show: {
						event: 'nectarcrm.Validation.Show.Messsage'
					},
					hide: {
						event: 'nectarcrm.Validation.Hide.Messsage'
					},
				...
				element.trigger('nectarcrm.Validation.Show.Messsage');
			}
			/*
		...
		success: function (label, element) {
			...
			element.trigger('nectarcrm.Validation.Hide.Messsage');
...
//		});
		...
		this.on('nectarcrm.PostReference.Selection nectarcrm.PostReference.QuickCreateSave', function (e) {
