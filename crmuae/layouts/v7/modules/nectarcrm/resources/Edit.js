...
nectarcrm_Index_Js("nectarcrm_Edit_Js",{
    ...
    postReferencePopUpOpenEvent : "nectarcrm.Referece.Popup.Post",
    
    referenceSelectionEvent : "nectarcrm.Reference.Selection",
    
    postReferenceSelectionEvent: "nectarcrm.PostReference.Selection",
    
    postReferenceQuickCreateSave: "nectarcrm.PostReference.QuickCreateSave",
    
    refrenceMultiSelectionEvent : "nectarcrm.MultiReference.Selection",
    
    postReferenceQuickCreateSaveEvent : "nectarcrm.PostReferenceQuickCreate.Save",
    
    popupSelectionEvent : "nectarcrm.Reference.Popup.Selection",
	...
	registerEventForImageDelete : function(){
        ...
        registerFileElementChangeEvent : function(container) {
            ...
            container.on('change', 'input[name="imagename[]"],input[name="sentdocument"]', function(e){
                ...
                nectarcrm_Edit_Js.file = e.target.files[0];
