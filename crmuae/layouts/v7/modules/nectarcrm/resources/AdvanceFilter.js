...
jQuery.Class("nectarcrm_AdvanceFilter_Js",{
	
	getInstance: function(container){
		var module = app.getModuleName();
		var moduleClassName = module+"_AdvanceFilter_Js";
		var fallbackClassName = "nectarcrm_AdvanceFilter_Js";
	...
	loadFieldSpecificUi : function(fieldSelect) {
		...
		var fieldModel = nectarcrm_Field_Js.getInstance(fieldInfo,moduleName);
	...
	addValidationToFieldIfNeeded : function(selectFieldElement) {
		...
		if(this.isFieldSupportsValidation(selectFieldElement)) {
			...
			fieldSpecificElement.addClass('validate[funcCall[nectarcrm_Base_Validator_Js.invokeValidation]]')
								.attr('data-validation-engine','validate[funcCall[nectarcrm_Base_Validator_Js.invokeValidation]]')
			...
			fieldSpecificElement.removeClass('validate[funcCall[nectarcrm_Base_Validator_Js.invokeValidation]]')
...
nectarcrm_Field_Js('AdvanceFilter_Field_Js',{},{
...
nectarcrm_Currencylist_Field_Js('AdvanceFilter_Currencylist_Field_Js',{},{
	/**
...
nectarcrm_Picklist_Field_Js('AdvanceFilter_Picklist_Field_Js',{},{
...
nectarcrm_Multipicklist_Field_Js('AdvanceFilter_Multipicklist_Field_Js',{},{
...
nectarcrm_Owner_Field_Js('AdvanceFilter_Owner_Field_Js',{},{
...
nectarcrm_Owner_Field_Js('nectarcrm_Ownergroup_Field_Js',{},{
	getUi : function() {
...
nectarcrm_Date_Field_Js('AdvanceFilter_Date_Field_Js',{},{
	/**
	 * Function to get the ui
