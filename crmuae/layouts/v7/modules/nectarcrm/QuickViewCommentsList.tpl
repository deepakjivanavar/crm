                                        ...
                                        <div class="comment col-lg-10">
                                            ...
                                            <div class="commentActionsContainer">      
                                                <span class="commentTime pull-right">
                                                    <p class="muted"><small title="{nectarcrm_Util_Helper::formatDateTimeIntoDayString($COMMENT->getCommentedTime())}">{nectarcrm_Util_Helper::formatDateAndDateDiffInString($COMMENT->getCommentedTime())}</small></p>
                                                </span>
                                            </div>
                                            <div style="margin-top:5px;">
                                                ...
                                                {foreach key=index item=FILE_DETAIL from=$FILE_DETAILS}
                                                    ...
                                                    {if !empty($FILE_NAME)}
                                                        <a onclick="nectarcrm_List_Js.previewFile(event,{$COMMENT->get('id')},{$FILE_DETAIL['attachmentId']});" data-filename="{$FILE_NAME}" href="javascript:void(0)" name="viewfile">
