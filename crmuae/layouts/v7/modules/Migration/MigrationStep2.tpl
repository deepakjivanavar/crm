...
{strip}
	...
	<div class="container-fluid page-container">
		<div class="row">
			<div class="col-lg-6">
				<div class="logo">
					<img src="{'logo.png'|vimage_path}" alt="nectarcrm Logo"/>
				</div>
			</div>
			<div class="col-lg-6">
			...
			<div class="col-lg-12 inner-container">
				...
				<div class="row">
					<div class="col-lg-5 welcome-image">
						<img src="{vimage_path('migration_screen.png')}" alt="nectarcrm Logo" style="width:80%;"/>
					</div>
					...
					<div class="col-lg-6">
						...
						Connect with us &nbsp;&nbsp;
						<a href="https://www.facebook.com/nectarcrm" target="_blank"><img src="layouts/v7/skins/images/facebook.png"></a>&nbsp;&nbsp;
						<a href="https://twitter.com/nectarcrmcrm" target="_blank"><img src="layouts/v7/skins/images/twitter.png"></a>&nbsp;&nbsp;
					</div>
				</div>
