...
{strip}
	<style>
		body {
			...
			/*background: url(layouts/v7/resources/Images/CRM.jpg);*/
		...
		.buttonBlue {
			...
			background: linear-gradient(to right, #f26923, #d83b4e);*/
			background: linear-gradient(to right, #ff7314, #e65f03);
			border-radius: 4px;
		}
		.buttonBlue:hover {
			/*background-image: linear-gradient(to bottom, #35aa47 0px, #35aa47 100%)*/
			 background-image: linear-gradient(to bottom, #262262 0%, #262262 100%);
		}
		.ripples {
			position: absolute;
			top: 0;
	...
	<div class="col-lg-12">
		<div class="col-lg-4 col-lg-offset-4">
			<div class="loginDiv widgetHeight">
				<img class="img-responsive user-logo" src="layouts/v7/resources/Images/nectarcrm.png">
				<div>
				...
				<div id="loginFormDiv">
					<form class="form-horizontal" method="POST" action="index.php">
						...
						<div class="group">
							...
							<a class="forgotPasswordLink" style="color: #428bca;">Forgot Password?</a>
						</div>
					</form>
				</div>
