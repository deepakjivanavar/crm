...
Inventory_Edit_Js("PurchaseOrder_Edit_Js",{},{
    ...
    registerReferenceSelectionEvent : function(container) { 
		...
		jQuery('input[name="vendor_id"]', container).on(nectarcrm_Edit_Js.referenceSelectionEvent, function(e, data){ 
			self.referenceSelectionEventHandler(data, container);
		});

		jQuery('input[name="accountid"]', container).on(nectarcrm_Edit_Js.referenceSelectionEvent, function(e, data){ 
			self.referenceSelectionEventHandler(data, container);
		});
	},
