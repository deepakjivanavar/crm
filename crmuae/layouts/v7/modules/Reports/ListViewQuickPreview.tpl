    ...
    <div class='quick-preview-modal modal-content'>
        <div class='modal-body'>
            ...
            <div class="quickPreviewSummary">
                ...
                <input type='hidden' name='data' value='{nectarcrm_Functions::jsonEncode($DATA)}' />
...
<script type="text/javascript">
    {$CLASS_NAME}('nectarcrm_ChartReportWidget_{$RECORD_ID}',{}, {
        init: function () {
            this._super(jQuery(".quickPreviewSummary"));
        }
    });

    var i = new nectarcrm_ChartReportWidget_{$RECORD_ID}();
