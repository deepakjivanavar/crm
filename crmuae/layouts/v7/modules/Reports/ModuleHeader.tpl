							...
							<span class="btn-group">
								...
								<ul class="dropdown-menu">
									{foreach item="childLink" from=$childLinks}
										...
										{/if}
										<li id="{$MODULE}_listView_basicAction_{nectarcrm_Util_Helper::replaceSpaceWithUnderScores($childLink->getLabel())}" data-edition-disable="{$childLink->disabled}" data-edition-message="{$childLink->message}">
