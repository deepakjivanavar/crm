        ...
        <div id="scheduleBox" class='row well contentsBackground {if $SCHEDULEDREPORTS->get('scheduleid') eq ''} hide {/if}'>
            ...
            <div class='col-lg-12' id='specificemailsids' style='padding:5px 0px 10px 0px;'>
                ...
                <div class='col-lg-4'>
                    ...
                    <input id="specificemails" style="width: 281px !important;" class="col-lg-6 inputElement" type="text" value="{$specificemailids}" name="specificemails" data-validation-engine="validate[funcCall[nectarcrm_MultiEmails_Validator_Js.invokeValidation]]"></input>
                </div>
            </div>
            {if $TYPE neq 'Chart'}
                <div class='col-lg-12' id='fileformat' style='padding:5px 0px 10px 0px;'>
                    ...
                    <div class='col-lg-2'>
                        <select class="select2 inputElement" id='fileformat' name='fileformat' data-validation-engine="validate[required,funcCall[nectarcrm_Base_Validator_Js.invokeValidation]]" >
