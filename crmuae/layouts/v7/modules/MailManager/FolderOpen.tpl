                    ...
                    <div class="col-lg-11 mmfolderMails padding0px" title="{$MAIL->subject()}">
                        ...
                        <div class="col-lg-4 padding0px">
                            ...
                            <span class="pull-right">
                                ...
                                {/if}
                                <span class='mmDateTimeValue' title="{nectarcrm_Util_Helper::formatDateTimeIntoDayString(date('Y-m-d H:i:s', strtotime($MAIL->_date)))}">{nectarcrm_Util_Helper::formatDateDiffInStrings(date('Y-m-d H:i:s', strtotime($MAIL->_date)))}</span>
                            </span>
                        </div>
