...
class nectarcrm_Request {
	...
	function __construct($values, $rawvalues = array(), $stripifgpc=true) {
        	nectarcrm_Functions::validateRequestParameters($values);
	...
	public function getForSql($key, $skipEmtpy=true) {
		return nectarcrm_Util_Helper::validateStringForSql($this->get($key), $skipEmtpy);
	}
	...
	* @param $viewer <nectarcrm_Viewer> - template object 
	*/
