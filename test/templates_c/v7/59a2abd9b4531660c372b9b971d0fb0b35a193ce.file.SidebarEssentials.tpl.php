<?php /* Smarty version Smarty-3.1.7, created on 2020-01-31 06:47:20
         compiled from "/var/www/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/partials/SidebarEssentials.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12779679265de797b02634e1-35269596%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '59a2abd9b4531660c372b9b971d0fb0b35a193ce' => 
    array (
      0 => '/var/www/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/partials/SidebarEssentials.tpl',
      1 => 1580453237,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12779679265de797b02634e1-35269596',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5de797b034b64',
  'variables' => 
  array (
    'MODULE' => 0,
    'CUSTOM_VIEWS' => 0,
...
<?php if ($_valid && !is_callable('content_5de797b034b64')) {function content_5de797b034b64($_smarty_tpl) {?>
...
" data-isMine="<?php if ($_smarty_tpl->tpl_vars['CUSTOM_VIEW']->value->isMine()){?>true<?php }else{ ?>false<?php }?>">
 ...
 <?php echo strtolower(vtranslate('LBL_MORE','nectarcrm'));?>
" data-less-text="Show less">
 ...
 <?php echo strtolower(vtranslate('LBL_MORE','nectarcrm'));?>
					...
					<?php } ?>
							...
							<input type="hidden" id='allFilterNames'  value='<?php echo nectarcrm_Util_Helper::toSafeHTML(Zend_JSON::encode($_smarty_tpl->tpl_vars['CUSTOM_VIEWS_NAMES']->value));?>
'/>
 ...
 ... </center></h6>
    ...
    <?php $_smarty_tpl->tpl_vars['EXTENSION_LINKS'] = new Smarty_variable(nectarcrm_Extension_View::getExtensionLinks($_smarty_tpl->tpl_vars['MODULE']->value), null, 0);?>
...
" <?php }?>
                    data-list-tag-count="<?php echo nectarcrm_Tag_Model::NUM_OF_TAGS_LIST;?>
">
...
?>
                            ...
                            <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['tagCounter']['iteration']>nectarcrm_Tag_Model::NUM_OF_TAGS_LIST){?>
                                <?php break 1?>
                            <?php }?>
                        ...
                        <?php } ?>
                        <div> 
                            <a class="moreTags <?php if ((count($_smarty_tpl->tpl_vars['TAGS']->value)-nectarcrm_Tag_Model::NUM_OF_TAGS_LIST)<=0){?> hide <?php }?>">
                                <span class="moreTagCount"><?php echo count($_smarty_tpl->tpl_vars['TAGS']->value)-nectarcrm_Tag_Model::NUM_OF_TAGS_LIST;?>
</span>
...
?>
                ...
                <div id="dummyTagElement" class="hide">
                    <?php $_smarty_tpl->tpl_vars['TAG_MODEL'] = new Smarty_variable(nectarcrm_Tag_Model::getCleanInstance(), null, 0);?>
                    ...
                    <div class="editTagContainer hide">
                        ...
                        <div class="editTagContents">
                            ...
                            <div>
                                <div class="checkbox">
                                    <label>
                                        <input type="hidden" name="visibility" value="<?php echo nectarcrm_Tag_Model::PRIVATE_TYPE;?>
"/>
