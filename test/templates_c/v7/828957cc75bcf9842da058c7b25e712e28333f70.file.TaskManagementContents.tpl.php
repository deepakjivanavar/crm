<?php /* Smarty version Smarty-3.1.7, created on 2022-08-24 09:29:32
         compiled from "C:\xampp\htdocs\CRM\crmuatbkup10-08-2022\crmuat\includes\runtime/../../layouts/v7\modules\Calendar\TaskManagementContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:400468176305ef7c7b8a36-38355774%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '828957cc75bcf9842da058c7b25e712e28333f70' => 
    array (
      0 => 'C:\\xampp\\htdocs\\CRM\\crmuatbkup10-08-2022\\crmuat\\includes\\runtime/../../layouts/v7\\modules\\Calendar\\TaskManagementContents.tpl',
      1 => 1660294238,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '400468176305ef7c7b8a36-38355774',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6305ef7c889c5',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6305ef7c889c5')) {function content_6305ef7c889c5($_smarty_tpl) {?>

<?php $_smarty_tpl->tpl_vars['MODULE_MODEL'] = new Smarty_variable(nectarcrm_Module_Model::getInstance($_smarty_tpl->tpl_vars['MODULE']->value), null, 0);?><?php $_smarty_tpl->tpl_vars['SELECTED_PICKLIST_FIELDMODEL'] = new Smarty_variable(nectarcrm_Field_Model::getInstance('taskstatus',$_smarty_tpl->tpl_vars['MODULE_MODEL']->value), null, 0);?><?php $_smarty_tpl->tpl_vars['PICKLIST_COLOR_MAP'] = new Smarty_variable(Settings_Picklist_Module_Model::getPicklistColorMap($_smarty_tpl->tpl_vars['SELECTED_PICKLIST_FIELDMODEL']->value->getName()), null, 0);?><style type="text/css"><?php  $_smarty_tpl->tpl_vars['PICKLIST_COLOR'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['PICKLIST_COLOR']->_loop = false;
...
</a></div><?php $_smarty_tpl->tpl_vars['SELECTED_PICKLISTFIELD_ALL_VALUES'] = new Smarty_variable(nectarcrm_Util_Helper::getPickListValues('taskstatus'), null, 0);?><?php  $_smarty_tpl->tpl_vars['PICKLIST_VALUE'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['PICKLIST_VALUE']->_loop = false;
...
</a></span></span><?php }?><?php if (!empty($_smarty_tpl->tpl_vars['RELATED_CONTACT']->value['id'])){?><span class='related_contact' style='margin-left: 8px;'><span style="font-size: 12px;"><?php echo nectarcrm_Module_Model::getModuleIconPath('Contacts');?>
