<?php /* Smarty version Smarty-3.1.7, created on 2019-10-21 06:50:21
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/v7\modules\Settings\CustomerPortal\CustomerPortalDashboard.tpl" */ ?>
<?php /*%%SmartyHeaderCode:597904085dad552d5ea908-22775436%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0b81f0edcfdd9c62f5cf7577a59952f5a0f65b84' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/v7\\modules\\Settings\\CustomerPortal\\CustomerPortalDashboard.tpl',
      1 => 1571119990,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '597904085dad552d5ea908-22775436',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dad552d604c8',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dad552d604c8')) {function content_5dad552d604c8($_smarty_tpl) {?>
...
<?php $_tmp1=ob_get_clean();?><?php echo vtranslate($_tmp1,'nectarcrm');?>
...
?><?php if ($_smarty_tpl->tpl_vars['module']->value!='HelpDesk'&&isset($_smarty_tpl->tpl_vars['WIDGETS_MODULE_LIST']->value[$_smarty_tpl->tpl_vars['module']->value])){?><div class="portal-helpdesk-widget-container" ><div class="portal-helpdesk-widget-header" ><h5><?php echo vtranslate('LBL_RECENT',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
 <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['module']->value;?>
<?php $_tmp3=ob_get_clean();?><?php echo vtranslate($_tmp3,'nectarcrm');?>
 <?php echo vtranslate('LBL_REC_WIDGET',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
