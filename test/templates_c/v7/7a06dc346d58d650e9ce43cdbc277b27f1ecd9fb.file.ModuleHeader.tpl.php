<?php /* Smarty version Smarty-3.1.7, created on 2022-08-08 05:31:10
         compiled from "/home/crmotakuneeds/public_html/crmuat/includes/runtime/../../layouts/v7/modules/Settings/nectarcrm/ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:73422718962f09f9e0cc182-13017965%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7a06dc346d58d650e9ce43cdbc277b27f1ecd9fb' => 
    array (
      0 => '/home/crmotakuneeds/public_html/crmuat/includes/runtime/../../layouts/v7/modules/Settings/nectarcrm/ModuleHeader.tpl',
      1 => 1655152000,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '73422718962f09f9e0cc182-13017965',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62f09f9e13cc7',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62f09f9e13cc7')) {function content_62f09f9e13cc7($_smarty_tpl) {?>
...
" href='index.php?module=nectarcrm&parent=Settings&view=Index'><h4 class="module-title pull-left text-uppercase"><?php echo vtranslate('LBL_HOME',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 </h4></a>&nbsp;<span class="fa fa-angle-right pull-left <?php if ($_smarty_tpl->tpl_vars['VIEW']->value=='Index'&&$_smarty_tpl->tpl_vars['MODULE']->value=='nectarcrm'){?> hide <?php }?>" aria-hidden="true" style="padding-top: 12px;padding-left: 5px; padding-right: 5px;"></span><?php }?><?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='nectarcrm'||$_REQUEST['view']!='Index'){?><?php if ($_smarty_tpl->tpl_vars['ACTIVE_BLOCK']->value['block']){?><span class="current-filter-name filter-name pull-left"><?php echo vtranslate($_smarty_tpl->tpl_vars['ACTIVE_BLOCK']->value['block'],$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
&nbsp;<span class="fa fa-angle-right" aria-hidden="true"></span>&nbsp;</span><?php }?><?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='nectarcrm'){?><?php $_smarty_tpl->tpl_vars['ALLOWED_MODULES'] = new Smarty_variable(explode(",",'Users,Profiles,Groups,Roles,Webforms,Workflows'), null, 0);?><?php if ($_smarty_tpl->tpl_vars['MODULE_MODEL']->value&&in_array($_smarty_tpl->tpl_vars['MODULE']->value,$_smarty_tpl->tpl_vars['ALLOWED_MODULES']->value)){?><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Webforms'){?><?php $_smarty_tpl->tpl_vars['URL'] = new Smarty_variable($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getListViewUrl(), null, 0);?><?php }else{ ?><?php $_smarty_tpl->tpl_vars['URL'] = new Smarty_variable($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getDefaultUrl(), null, 0);?><?php }?><?php if (strpos($_smarty_tpl->tpl_vars['URL']->value,'parent')==''){?><?php $_smarty_tpl->tpl_vars['URL'] = new Smarty_variable((($_smarty_tpl->tpl_vars['URL']->value).('&parent=')).($_REQUEST['parent']), null, 0);?><?php }?><?php }?><span class="current-filter-name settingModuleName filter-name pull-left"><?php if ($_REQUEST['view']=='Calendar'){?><?php if ($_REQUEST['mode']=='Edit'){?><a href="<?php echo ((((("index.php?module=").($_REQUEST['module'])).('&parent=')).($_REQUEST['parent'])).('&view=')).($_REQUEST['view']);?>
...
_basicAction_<?php echo nectarcrm_Util_Helper::replaceSpaceWithUnderScores($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getLabel());?>
...
;'<?php }else{ ?>onclick="nectarcrm_Import_Js.triggerImportAction('<?php echo $_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getUrl();?>
...
_listView_basicAction_<?php echo nectarcrm_Util_Helper::replaceSpaceWithUnderScores($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getLabel());?>
...
_listView_basicAction_<?php echo nectarcrm_Util_Helper::replaceSpaceWithUnderScores($_smarty_tpl->tpl_vars['LISTVIEW_BASICACTION']->value->getLabel());?>
