<?php /* Smarty version Smarty-3.1.7, created on 2019-12-06 11:28:06
         compiled from "/var/www/crmuat/includes/runtime/../../layouts/v7/modules/Import/ImportResult.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16416062475dea3b4660f921-94886568%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '02a571707c3e2356a6df7086742a9bc7fa3f2b8a' => 
    array (
      0 => '/var/www/crmuat/includes/runtime/../../layouts/v7/modules/Import/ImportResult.tpl',
      1 => 1574851706,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16416062475dea3b4660f921-94886568',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dea3b466732e',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dea3b466732e')) {function content_5dea3b466732e($_smarty_tpl) {?>
       ...
       <div class="row clearfix">
            <div class='textAlignCenter col-lg-12 col-md-12 col-sm-12 '>
                <button name="next" class="btn btn-primary btn-lg"
                        onclick="return nectarcrm_Import_Js.triggerImportAction();"><?php echo vtranslate('LBL_IMPORT_MORE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button>
                &nbsp;&nbsp;&nbsp;
                <?php if ($_smarty_tpl->tpl_vars['MERGE_ENABLED']->value=='0'){?>
                    <button name="next" class="btn btn-danger btn-lg"
                            onclick="nectarcrm_Import_Js.undoImport('index.php?module=<?php echo $_smarty_tpl->tpl_vars['FOR_MODULE']->value;?>
...
')"><?php echo vtranslate('LBL_UNDO_LAST_IMPORT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
                    ...
                    &nbsp;&nbsp;&nbsp;
                <?php }?>
                <button class='btn btn-success btn-lg' data-dismiss="modal" onclick="nectarcrm_Import_Js.loadListRecords();"><?php echo vtranslate('LBL_FINISH',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button>
            </div>
        </div>
    </div>
