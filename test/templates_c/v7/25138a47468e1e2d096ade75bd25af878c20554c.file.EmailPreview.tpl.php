<?php /* Smarty version Smarty-3.1.7, created on 2020-07-02 16:43:03
         compiled from "/var/www/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/EmailPreview.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17215671635ef730f7894fc3-81687276%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '25138a47468e1e2d096ade75bd25af878c20554c' => 
    array (
      0 => '/var/www/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/EmailPreview.tpl',
      1 => 1593708141,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17215671635ef730f7894fc3-81687276',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5ef730f8457d3',
  'variables' => 
  array (
    'PARENT_RECORD' => 0,
    'RECORD_ID' => 0,
...
<?php if ($_valid && !is_callable('content_5ef730f8457d3')) {function content_5ef730f8457d3($_smarty_tpl) {?>
...
</div></div><div class="col-lg-10"><div class="email-body-preview"><iframe frameBorder="0" scrolling='yes' id="emailPreviewIframe" style='width: 100%; ::-webkit-scrollbar {-webkit-appearance: none;width: 10px;}::-webkit-scrollbar-thumb {border-radius: 5px;background-color: rgba(0,0,0,.5);-webkit-box-shadow: 0 0 1px rgba(255,255,255,.5);} height:100%;'></iframe></div></div></div><hr><div class="row"><span class="col-lg-12" style="text-align: center;"><span class="muted"><?php if ($_smarty_tpl->tpl_vars['RECORD']->value->get('email_flag')=="SAVED"){?><small><em><?php echo vtranslate('LBL_DRAFTED_ON',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</em></small><span><small><em>&nbsp;<?php echo nectarcrm_Util_Helper::formatDateTimeIntoDayString($_smarty_tpl->tpl_vars['RECORD']->value->get('createdtime'));?>
</em></small></span><?php }else{ ?><small><em><?php echo vtranslate('LBL_SENT_ON',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</em></small><?php $_smarty_tpl->tpl_vars["SEND_TIME"] = new Smarty_variable((($_smarty_tpl->tpl_vars['RECORD']->value->get('date_start')).(' ')).($_smarty_tpl->tpl_vars['RECORD']->value->get('time_start')), null, 0);?><span><small><em>&nbsp;<?php echo nectarcrm_Util_Helper::formatDateTimeIntoDayString($_smarty_tpl->tpl_vars['SEND_TIME']->value);?>
