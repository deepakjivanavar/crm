<?php /* Smarty version Smarty-3.1.7, created on 2022-08-08 06:14:18
         compiled from "/home/crmotakuneeds/public_html/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/DetailViewTagList.tpl" */ ?>
<?php /*%%SmartyHeaderCode:120082186062f0a9ba24fce6-16807903%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0b162677903326993311e463de3d54266bb23534' => 
    array (
      0 => '/home/crmotakuneeds/public_html/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/DetailViewTagList.tpl',
      1 => 1655151940,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '120082186062f0a9ba24fce6-16807903',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62f0a9ba26c8c',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62f0a9ba26c8c')) {function content_62f0a9ba26c8c($_smarty_tpl) {?>
<div class="tagContainer">
    <div class="tag-contents <?php if (empty($_smarty_tpl->tpl_vars['TAGS_LIST']->value)){?> hide<?php }?>">
        <div class="detailTagList" data-num-of-tags-to-show="<?php echo nectarcrm_Tag_Model::NUM_OF_TAGS_DETAIL;?>
">
...
?>
                <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['tagCounter']['iteration']>nectarcrm_Tag_Model::NUM_OF_TAGS_DETAIL){?>
                     <?php break 1?>
                <?php }?>
            ...
            <a href="javascript:void(0);" class="moreTags <?php if (count($_smarty_tpl->tpl_vars['TAGS_LIST']->value)<=nectarcrm_Tag_Model::NUM_OF_TAGS_DETAIL){?> hide <?php }?>">
                <span class="tagMoreCount"><?php echo count($_smarty_tpl->tpl_vars['TAGS_LIST']->value)-nectarcrm_Tag_Model::NUM_OF_TAGS_DETAIL;?>
</span>
