<?php /* Smarty version Smarty-3.1.7, created on 2019-10-21 05:26:04
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/v7\modules\CustomView\EditView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9444241495dad416cc31d33-61160968%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a98afc2981272c8c8b2fee8d08ba23231a2b8c22' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/v7\\modules\\CustomView\\EditView.tpl',
      1 => 1520586670,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9444241495dad416cc31d33-61160968',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dad416ccb8ee',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dad416ccb8ee')) {function content_5dad416ccb8ee($_smarty_tpl) {?>
...
" /><?php }?><input type="hidden" name="date_filters" data-value='<?php echo nectarcrm_Util_Helper::toSafeHTML(ZEND_JSON::encode($_smarty_tpl->tpl_vars['DATE_FILTERS']->value));?>
...
" data-rule-required="true" data-rule-maxsize="100" data-rule-check-filter-duplicate='<?php echo nectarcrm_Util_Helper::toSafeHTML(Zend_JSON::encode($_smarty_tpl->tpl_vars['CUSTOM_VIEWS_LIST']->value));?>
...
" data-field-name="<?php echo $_smarty_tpl->tpl_vars['FIELD_NAME']->value;?>
"<?php if (in_array(decode_html($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getCustomViewColumnName()),$_smarty_tpl->tpl_vars['SELECTED_FIELDS']->value)){?>selected<?php }?>><?php echo nectarcrm_Util_Helper::toSafeHTML(vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label'),$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value));?>
<?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatory()==true){?> <span>*</span> <?php }?></option><?php } ?></optgroup><?php } ?></select><input type="hidden" name="columnslist" value='<?php echo nectarcrm_Functions::jsonEncode($_smarty_tpl->tpl_vars['SELECTED_FIELDS']->value);?>
' /><input id="mandatoryFieldsList" type="hidden" value='<?php echo nectarcrm_Util_Helper::toSafeHTML(ZEND_JSON::encode($_smarty_tpl->tpl_vars['MANDATORY_FIELDS']->value));?>
