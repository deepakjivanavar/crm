<?php /* Smarty version Smarty-3.1.7, created on 2019-10-18 11:10:38
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/v7\modules\Users\UserViewHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15669507585da99b16853528-90686919%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bcfbe1edcf911528a75bbe60b335edac16973463' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/v7\\modules\\Users\\UserViewHeader.tpl',
      1 => 1571397010,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15669507585da99b16853528-90686919',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5da99b1689de1',
  'variables' => 
  array (
    'RECORD' => 0,
    'IMAGE_INFO' => 0,
...
<?php if ($_valid && !is_callable('content_5da99b1689de1')) {function content_5da99b1689de1($_smarty_tpl) {?>
...
"><?php }else{ ?><?php $_smarty_tpl->tpl_vars['NOIMAGE'] = new Smarty_variable(1, null, 0);?><?php }?><?php } ?><?php if ($_smarty_tpl->tpl_vars['NOIMAGE']->value==1){?><div class="name"><span style="font-size:24px;"><strong> <?php echo substr($_smarty_tpl->tpl_vars['RECORD']->value->getName(),0,2);?>
 </strong></span></div><?php }?></div><span class="font-x-x-large headtitle"><?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getName();?>
...
_detailView_basicAction_<?php echo nectarcrm_Util_Helper::replaceSpaceWithUnderScores($_smarty_tpl->tpl_vars['DETAIL_VIEW_BASIC_LINK']->value->getLabel());?>
...
_detailView_moreAction_<?php echo nectarcrm_Util_Helper::replaceSpaceWithUnderScores($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel());?>
