<?php /* Smarty version Smarty-3.1.7, created on 2022-08-08 06:08:07
         compiled from "/home/crmotakuneeds/public_html/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:106941687962f0a847736089-13657617%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2682f4e073898b77b8cfafeb5521211a4218e136' => 
    array (
      0 => '/home/crmotakuneeds/public_html/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/ListViewContents.tpl',
      1 => 1655151934,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '106941687962f0a847736089-13657617',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62f0a8477ed1c',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62f0a8477ed1c')) {function content_62f0a8477ed1c($_smarty_tpl) {?>
...
<div class="col-sm-12 col-xs-12 ">
	<?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='EmailTemplates'&&$_smarty_tpl->tpl_vars['SEARCH_MODE_RESULTS']->value!=true){?>
		...
		<div class="essentials-toggle" title="<?php echo vtranslate('LBL_LEFT_PANEL_SHOW_HIDE','nectarcrm');?>
">
...
" id="noOfEntries">
	<input type="hidden" name="currentSearchParams" value="<?php echo nectarcrm_Util_Helper::toSafeHTML(Zend_JSON::encode($_smarty_tpl->tpl_vars['SEARCH_DETAILS']->value));?>
" id="currentSearchParams" />
	<input type="hidden" name="currentTagParams" value="<?php echo nectarcrm_Util_Helper::toSafeHTML(Zend_JSON::encode($_smarty_tpl->tpl_vars['TAG_DETAILS']->value));?>
" id="currentTagParams" />
...
">
	...
	<?php if (!empty($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value)){?>
		<input type="hidden" name="picklistDependency" value='<?php echo nectarcrm_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value);?>
' />
	<?php }?>
...
"
										 <?php }elseif(!$_smarty_tpl->tpl_vars['CURRENT_CV_MODEL']->value->isMine()){?>
											 ...
											 <?php if (!nectarcrm_Functions::isUserExist($_smarty_tpl->tpl_vars['CURRENT_CV_USER_ID']->value)){?>
...
<?php $_tmp2=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['PICKLIST_FIELD_ID'] = new Smarty_variable($_tmp2, null, 0);?>
											<?php }else{ ?>
												<?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getName()=='taskstatus'){?>
													<?php $_smarty_tpl->tpl_vars["EVENT_STATUS_FIELD_MODEL"] = new Smarty_variable(nectarcrm_Field_Model::getInstance('eventstatus',nectarcrm_Module_Model::getInstance('Events')), null, 0);?>
...
-<?php echo nectarcrm_Util_Helper::convertSpaceToHyphen($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_RAWVALUE']->value);?>
...
-<?php echo nectarcrm_Util_Helper::convertSpaceToHyphen(trim($_smarty_tpl->tpl_vars['ALL_MULTI_PICKLIST_VALUES']->value[trim($_smarty_tpl->tpl_vars['MULTI_PICKLIST_VALUE']->value)]));?>
"<?php }?> > 
