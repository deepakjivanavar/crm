<?php /* Smarty version Smarty-3.1.7, created on 2019-11-21 11:55:52
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/v7\modules\Project\SummaryViewWidgets.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15454837205dd67b4878a2e8-21648156%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7ad903e57224ef99076322078107a9bdb208d935' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/v7\\modules\\Project\\SummaryViewWidgets.tpl',
      1 => 1571120085,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15454837205dd67b4878a2e8-21648156',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dd67b488d5af',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dd67b488d5af')) {function content_5dd67b488d5af($_smarty_tpl) {?>
...
')"><img style="  margin-top: -3px;margin-right: 4%;" title="nectarcrm" alt="nectarcrm" src="layouts/v7/skins//images/nectarcrm.png"><?php ob_start();?><?php echo vtranslate('LBL_NECTARCRM','Documents');?>
...
" data-validation-engine="validate[<?php if ($_smarty_tpl->tpl_vars['PROGRESS_FIELD_MODEL']->value->isMandatory()==true){?> required,<?php }?>funcCall[nectarcrm_Base_Validator_Js.invokeValidation]]" data-fieldinfo='<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['FIELD_INFO']->value, ENT_QUOTES, 'UTF-8', true);?>
' <?php if (!empty($_smarty_tpl->tpl_vars['SPECIAL_VALIDATOR']->value)){?>data-validator='<?php echo Zend_Json::encode($_smarty_tpl->tpl_vars['SPECIAL_VALIDATOR']->value);?>
...
" data-validation-engine="validate[<?php if ($_smarty_tpl->tpl_vars['STATUS_FIELD_MODEL']->value->isMandatory()==true){?> required,<?php }?>funcCall[nectarcrm_Base_Validator_Js.invokeValidation]]" data-fieldinfo='<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['FIELD_INFO']->value, ENT_QUOTES, 'UTF-8', true);?>
' <?php if (!empty($_smarty_tpl->tpl_vars['SPECIAL_VALIDATOR']->value)){?>data-validator='<?php echo Zend_Json::encode($_smarty_tpl->tpl_vars['SPECIAL_VALIDATOR']->value);?>
'<?php }?> ><option value=""><?php echo vtranslate('LBL_SELECT_STATUS',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</option><?php  $_smarty_tpl->tpl_vars['PICKLIST_VALUE'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['PICKLIST_VALUE']->_loop = false;
 $_smarty_tpl->tpl_vars['PICKLIST_NAME'] = new Smarty_Variable;
