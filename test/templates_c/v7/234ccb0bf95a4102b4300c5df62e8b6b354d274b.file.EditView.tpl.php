<?php /* Smarty version Smarty-3.1.7, created on 2020-06-16 06:37:25
         compiled from "/var/www/crmuat/includes/runtime/../../layouts/v7/modules/Settings/Picklist/EditView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20834503445ee868a54e72f4-16313617%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '234ccb0bf95a4102b4300c5df62e8b6b354d274b' => 
    array (
      0 => '/var/www/crmuat/includes/runtime/../../layouts/v7/modules/Settings/Picklist/EditView.tpl',
      1 => 1574851726,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20834503445ee868a54e72f4-16313617',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ee868a56a6dd',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ee868a56a6dd')) {function content_5ee868a56a6dd($_smarty_tpl) {?>
...
" /><input type="hidden" name="pickListValues" value='<?php echo nectarcrm_Util_Helper::toSafeHTML(ZEND_JSON::encode($_smarty_tpl->tpl_vars['SELECTED_PICKLISTFIELD_EDITABLE_VALUES']->value));?>
' /><input type="hidden" name="picklistColorMap" value='<?php echo nectarcrm_Util_Helper::toSafeHTML(ZEND_JSON::encode(Settings_Picklist_Module_Model::getPicklistColorMap($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name'))));?>
...
?><option <?php if ($_smarty_tpl->tpl_vars['FIELD_VALUE']->value==$_smarty_tpl->tpl_vars['PICKLIST_VALUE']->value){?> selected="" <?php }?>value="<?php echo nectarcrm_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKLIST_VALUE']->value);?>
...
?><option data-edit-disabled="true" <?php if ($_smarty_tpl->tpl_vars['FIELD_VALUE']->value==$_smarty_tpl->tpl_vars['NON_EDITABLE_VALUE']->value){?> selected="" <?php }?>value="<?php echo nectarcrm_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['NON_EDITABLE_VALUE']->value);?>
