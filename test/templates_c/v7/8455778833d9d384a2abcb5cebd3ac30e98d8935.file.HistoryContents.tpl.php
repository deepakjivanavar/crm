<?php /* Smarty version Smarty-3.1.7, created on 2022-08-08 05:26:14
         compiled from "/home/crmotakuneeds/public_html/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/dashboards/HistoryContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:130252499762f09e76ecabd5-07822664%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8455778833d9d384a2abcb5cebd3ac30e98d8935' => 
    array (
      0 => '/home/crmotakuneeds/public_html/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/dashboards/HistoryContents.tpl',
      1 => 1655151956,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '130252499762f09e76ecabd5-07822664',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62f09e7700f24',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62f09e7700f24')) {function content_62f09e7700f24($_smarty_tpl) {?>
...
?>
 ...
 <b><?php echo nectarcrm_Util_Helper::tonectarcrm6SafeHTML($_smarty_tpl->tpl_vars['FIELD']->value->getDisplayValue(decode_html($_smarty_tpl->tpl_vars['FIELD']->value->get('prevalue'))));?>
</b>
 ...
 </b> ( <del><?php echo nectarcrm_Util_Helper::tonectarcrm6SafeHTML($_smarty_tpl->tpl_vars['FIELD']->value->getDisplayValue(decode_html($_smarty_tpl->tpl_vars['FIELD']->value->get('prevalue'))));?>
</del> )
													<?php }else{ ?>
 ...
 <b><?php echo nectarcrm_Util_Helper::tonectarcrm6SafeHTML($_smarty_tpl->tpl_vars['FIELD']->value->getDisplayValue(decode_html($_smarty_tpl->tpl_vars['FIELD']->value->get('postvalue'))));?>
</b>
													<?php }?>    
												</div>
											<?php }?>
...
"' <?php }?>>
					...
					<?php if ($_smarty_tpl->tpl_vars['TIME']->value){?><p class="pull-right muted" style="padding-right:10px;"><small title="<?php echo nectarcrm_Util_Helper::formatDateTimeIntoDayString(($_smarty_tpl->tpl_vars['TIME']->value));?>
"><?php echo nectarcrm_Util_Helper::formatDateDiffInStrings(($_smarty_tpl->tpl_vars['TIME']->value));?>
</small></p><?php }?>
				</div>
			<?php }?>
...
"</i></div>
					...
					<p class="pull-right muted" style="padding-right:10px;"><small title="<?php echo nectarcrm_Util_Helper::formatDateTimeIntoDayString(($_smarty_tpl->tpl_vars['COMMENT_TIME']->value));?>
"><?php echo nectarcrm_Util_Helper::formatDateDiffInStrings(($_smarty_tpl->tpl_vars['COMMENT_TIME']->value));?>
</small></p>
				</div>
			<?php }?>
		<?php } ?>
