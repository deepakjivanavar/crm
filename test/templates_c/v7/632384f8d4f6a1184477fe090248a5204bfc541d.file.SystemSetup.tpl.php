<?php /* Smarty version Smarty-3.1.7, created on 2019-11-27 09:22:13
         compiled from "D:\xamp\htdocs\crm\includes\runtime/../../layouts/v7\modules\Users\SystemSetup.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13613231335dde40454fd4d8-05666514%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '632384f8d4f6a1184477fe090248a5204bfc541d' => 
    array (
      0 => 'D:\\xamp\\htdocs\\crm\\includes\\runtime/../../layouts/v7\\modules\\Users\\SystemSetup.tpl',
      1 => 1574845213,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13613231335dde40454fd4d8-05666514',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dde40455f116',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dde40455f116')) {function content_5dde40455f116($_smarty_tpl) {?>

<html lang="en"><head><title>nectarcrm CRM Setup</title><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><link REL="SHORTCUT ICON" HREF="layouts/v7/skins/images/favicon.ico"><link rel="stylesheet" href="libraries/bootstrap/css/bootstrap.css" type="text/css" media="screen" /><link rel="stylesheet" href="libraries/bootstrap/css/bootstrap-responsive.css" type="text/css" media="screen"><style type="text/css">
					body{
				...
				</script><div class="container-fluid page-container"><div class="row-fluid"><div class="span6"><div class="logo"><img src="test/logo/nectarcrm-crm-logo.png" alt="nectarcrm Logo"/></div></div><div class="span6"></div></div><div class="row-fluid main-container"><div class="span12 inner-container"><div class="row-fluid"><div class="span8"><h3 style="display: inline-block;float:left;"> What would you like to use nectarcrm CRM for? </h3><p style="display: inline-block;float:left;margin-top:4px;">&nbsp;&nbsp;(Select features you want to enable)</p></div><div class="span4"><div class="pull-right"><label for="checkbox-1" style="vertical-align:bottom;margin:0;margin-top:8px\9;margin-left:10px\9;font-size:15px;"><strong> Select All</strong></label> <input type="checkbox" name="selectAll" class="selectAll"/><div class="chkbox"></div></div></div></div><hr><form id="SystemSetup" class="form" method="POST" action="index.php?module=Users&action=SystemSetupSave"><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable(0, null, 0);?><?php  $_smarty_tpl->tpl_vars['PACKAGE_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['PACKAGE_INFO']->_loop = false;
...
" alt="nectarcrm Logo"/></div><div class="<?php if ($_smarty_tpl->tpl_vars['COUNTER']->value==0){?> span10 <?php }else{ ?> span9 <?php }?>"><div class="group-heading"><h4><?php echo $_smarty_tpl->tpl_vars['PACKAGE_INFO']->value['label'];?>
