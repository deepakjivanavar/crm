<?php /* Smarty version Smarty-3.1.7, created on 2019-10-21 11:47:26
         compiled from "C:\xampp\htdocs\crm\includes\runtime/../../layouts/v7\modules\Inventory\partials\LineItemsContent.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20070175895dad9ace9685d9-29738565%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b1cba5f648a41aa9c66dbac198f599d73894ea17' => 
    array (
      0 => 'C:\\xampp\\htdocs\\crm\\includes\\runtime/../../layouts/v7\\modules\\Inventory\\partials\\LineItemsContent.tpl',
      1 => 1520586670,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20070175895dad9ace9685d9-29738565',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dad9acea54f3',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dad9acea54f3')) {function content_5dad9acea54f3($_smarty_tpl) {?>
...
" data-module-name="Services" data-field-name="serviceid"><?php echo nectarcrm_Module_Model::getModuleIconPath('Services');?>
...
" data-module-name="Products" data-field-name="productid"><?php echo nectarcrm_Module_Model::getModuleIconPath('Products');?>
...
" />&nbsp;<?php $_smarty_tpl->tpl_vars['PRICEBOOK_MODULE_MODEL'] = new Smarty_variable(nectarcrm_Module_Model::getInstance('PriceBooks'), null, 0);?><?php if ($_smarty_tpl->tpl_vars['PRICEBOOK_MODULE_MODEL']->value->isPermitted('DetailView')&&$_smarty_tpl->tpl_vars['MODULE']->value!='PurchaseOrder'){?><span class="priceBookPopup cursorPointer" data-popup="Popup"  title="<?php echo vtranslate('PriceBooks',$_smarty_tpl->tpl_vars['MODULE']->value);?>
" data-module-name="PriceBooks" style="float:left"><?php echo nectarcrm_Module_Model::getModuleIconPath('PriceBooks');?>
...
" data-compound-on="<?php if ($_smarty_tpl->tpl_vars['tax_data']->value['method']=='Compound'){?><?php echo nectarcrm_Util_Helper::toSafeHTML(Zend_Json::encode($_smarty_tpl->tpl_vars['tax_data']->value['compoundon']));?>
<?php }?>" data-regions-list="<?php echo nectarcrm_Util_Helper::toSafeHTML(Zend_Json::encode($_smarty_tpl->tpl_vars['tax_data']->value['regionsList']));?>
