<?php /* Smarty version Smarty-3.1.7, created on 2022-08-08 05:26:15
         compiled from "/home/crmotakuneeds/public_html/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/dashboards/CalendarActivitiesContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14609712162f09e7748bee1-90641725%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '33661b8ef98f0de549331f719ce8dab025ca41db' => 
    array (
      0 => '/home/crmotakuneeds/public_html/crmuat/includes/runtime/../../layouts/v7/modules/nectarcrm/dashboards/CalendarActivitiesContents.tpl',
      1 => 1655151958,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14609712162f09e7748bee1-90641725',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62f09e774a786',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62f09e774a786')) {function content_62f09e774a786($_smarty_tpl) {?>
...
<?php }?>
			...
			<p class='pull-right muted' style='margin-top:5px;padding-right:5px;'><small title="<?php echo nectarcrm_Util_Helper::formatDateTimeIntoDayString(($_smarty_tpl->tpl_vars['START_DATE']->value)." ".($_smarty_tpl->tpl_vars['START_TIME']->value));?>
 <?php echo vtranslate('LBL_TO');?>
 <?php echo nectarcrm_Util_Helper::formatDateTimeIntoDayString(($_smarty_tpl->tpl_vars['DUE_DATE']->value)." ".($_smarty_tpl->tpl_vars['DUE_TIME']->value));?>
"><?php echo nectarcrm_Util_Helper::formatDateDiffInStrings(($_smarty_tpl->tpl_vars['START_DATE']->value)." ".($_smarty_tpl->tpl_vars['START_TIME']->value));?>
</small></p>
